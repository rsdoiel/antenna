...
- [Latino USA](https://www.latinousa.org/feed/)

# Magazines

- Paste, <https://www.pastemagazine.com/rss.xml>, just don't read regularly but a nice site. RSD 2026-03-17

# Climate, Energy and the Economy

## Comercial sites

- [Sacramento Bee](https://feeds.mcclatchy.com/sacbee/stories)
  - Had a weird fetch errror when I added this. They use Akaimi CDN, not sure what was up. Was able to fetch feed via wget, then it started working on in my tests on wren. Let's see if it works again, RSD 2026-03-21
- [Greenland Monitor](https://www.greenlandmonitor.com/rss/)
...
-  The Long Games <https://podcasts.voxmedia.com/show/the-long-game>, failed to detect media type, RSD 2026-02-24
