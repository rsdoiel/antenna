...
<p>Digital accessibility to the scholarly communications process is core to providing equitable access to the literature.</p>
<p>The post <a href="https://scholarlykitchen.sspnet.org/2024/11/07/paywalls-are-not-the-only-barriers-to-access/">Paywalls are Not the Only Barriers to Access: Accessibility is Critical to Equitable Access</a> appeared first on <a href="https://scholarlykitchen.sspnet.org">The Scholarly Kitchen</a>.</p>
...
<p>In our <a href="https://www.crossref.org/blog/the-myth-of-perfect-metadata-matching">previous blog post</a> in this series, we explained why no metadata matching strategy can return perfect results. Thankfully, however, this does not mean that it&rsquo;s impossible to know anything about the quality of matching. Indeed, we can (and should!) measure how close (or far) we are from achieving perfection with our matching. Read on to learn how this can be done!</p>
