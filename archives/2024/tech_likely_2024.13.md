...
<p><img loading="lazy" src="2024-03-24-bolle-di-magadino-1.jpg" alt="" />
...
date: 2024-03-25, updated: 2024-03-25, from: Robin Rendle Essays

 

<https://robinrendle.com/notes/has-roundup/>
...
## Swiss PGDay 2024: Registration and Call for Sponsors

date: 2024-03-25, from: PostgreSQL News

<p>We are pleased to announce the call for sponsors and registration for the <strong>Swiss PGDay 2024</strong>, which will take place on <strong>Thursday, 27 June and Friday, 28 June 2024</strong> at the University of Applied Sciences of Eastern Switzerland, Campus <strong>Rapperswil (near Zurich)</strong>.</p>
<p><a href="https://www.pgday.ch/2024/#register"><em>Registration</em></a> is now open. We expect the schedule to be published by the end of April.</p>
<p>Companies can now take advantage of this unique opportunity to connect with the Swiss PostgreSQL community by sponsoring the event. See the <a href="https://www.pgday.ch/2024/#sponsoring"><em>Call for Sponsors</em></a> for details.</p>
<p>The <a href="https://www.pgday.ch/2024/#cfs"><em>Call for Speakers</em></a> is open until <strong>8 April 2024</strong>. You can also submit a poster description until 15 May 2024.</p>
<p>For the latest information on Swiss PGDay, visit the <a href="https://www.pgday.ch/">website</a> or follow us on <a href="https://fosstodon.org/@swiss_pgday">Mastodon</a>.</p>
<p>We look forward to seeing you in Rapperswil!</p>
<p>Best regards,<br>
Swiss PGDay Organizing Committee  </p>
<p><sub>This is a community conference according to the <a href="https://www.postgresql.org/about/policies/conferences/">PostgreSQL Community Conference Recognition Guidelines</a>. "PGDay" is a registered <a href="https://www.postgresql.eu/about/trademarks/">trademark of PostgreSQL Europe</a>, used with their permission.</sub></p> 

<https://www.postgresql.org/about/news/swiss-pgday-2024-registration-and-call-for-sponsors-2821/>
...
<p data-pm-slice="0 0 []">Originally presented at VCF SoCal in February of 2024.</p> <p>The cryotron, a superconductive switch, almost revolutionized computing. It's one of those fascinating near misses. In this episode we are talking about the history of the cryotron, how the NSA and supercomputing factors into the mix, and the current state of research into the topic. Did the NSA actually construct a supercomputer that ran in a vat of liquid helium? The answer is... maybe?</p> <p>Video of this talk:</p> <p><a href="https://youtu.be/FqzSGTZ3TMU" rel= "noopener noreferrer nofollow" data-link-auto= "">https://youtu.be/FqzSGTZ3TMU</a></p> 
...
So I went ahead and moved <a href="https://xmlrpc.com/">xmlrpc.com</a> to a HTTPS server. The <a href="http://scripting.com/2024/03/22/031933.html">other day</a> I forgot to mention that style sheets might not be readable when you move from HTTP to HTTPS, leading to <a href="https://imgs.scripting.com/2024/03/24/httpsBreaksSitesThanksGoogle.png">this striking breakage</a> I saw when I first got to look at the site in its new location. And now thanks to Google and the EFF, I get to spend time debugging something that worked just fine in 1998 and every year since then. Should I send them the bill for my time? Fuckers. 
...
<p>Credit:</p><p><a href="https://x.com/ryanels4/status/1771784932026691769?s=46" target="_blank" rel="nofollow noopener noreferrer" translate="no"><span class="invisible">https://</span><span class="ellipsis">x.com/ryanels4/status/17717849</span><span class="invisible">32026691769?s=46</span></a></p> 
...
<p>November 2023, 3 months before Congress drops the “TikTok is a danger to national security” we had this audio leaked:</p><p><a href="https://x.com/snarwani/status/1725138601996853424?s=20" target="_blank" rel="nofollow noopener noreferrer" translate="no"><span class="invisible">https://</span><span class="ellipsis">x.com/snarwani/status/17251386</span><span class="invisible">01996853424?s=20</span></a></p> 
...
date: 2024-03-24, updated: 2024-03-24, from: Jason Kottke blog
...
<p>Addendum: it is not a complex problem.</p><p>It is just a battle over taking the land that belonged to someone else and the ramifications of that.</p> 
...
## Newsboat 2.35 is out

date: 2024-03-24, updated: 2024-03-24, from: Newsboat News
            ...
            <p>
		The highlight for this one is Feedbin support. Feedbin is an
		online newsreading service in the vein of Google Reader, and we
		already support a bunch of similar ones. The feature request
                for Feedbin specifically was filed 4 years ago, and upvoted
		19 times — twice more often than the runner-up, a request for
		separators between groups of feeds. We‘ve been waiting for an
		interested person to tackle this, and finally James Vaughan
                showed up with a complete implementation. Please give it a spin
		if you‘ve been waiting for this functionality all these years,
                and thanks for your patience!
            </p>

            <p>
		Another notable feature is support for item starring with
		Miniflux. This was on the to-do list for a while too, and was
		implemented by gilcu3. Interestingly, both of these are first
		ever contributions; it‘s very nice to see new faces in
                Newsboat‘s pull requests!
            </p>

            <p>
		There‘s also a few new scripts in the contrib directory, and
		loads of internal reworking by Dennis van der Schagt and others.
		Probably some new bugs too, but Juho Eerola fixed one in 2.35,
                so let‘s call it even, ok?
            </p>

            <p>
                Well, enough chatter; go grab the source:
                <a href="https://newsboat.org/releases/2.35/newsboat-2.35.tar.xz">tarball</a>,
                <a href="https://newsboat.org/releases/2.35/newsboat-2.35.tar.xz.asc">its signature</a>,
                <a href="https://newsboat.org/releases/2.35/docs/newsboat.html">the docs</a>, and
                <a href="https://github.com/newsboat/newsboat/blob/master/CHANGELOG.md#235---2024-03-24">the changelog</a>.
            </p>
         

<https://newsboat.org/releases/2.35/docs/newsboat.html>
...
<p>I have followed the Palestinian struggle since about 2000 and read every book I could on the subject.</p><p>But TikTok has really made this knowledge accessible to the public.  The TikTokers know how to explain in small bursts like nothing I have seen before. </p><p>Accurate and concise.</p> 
...
<p><a class="tag" href="/search/?q=%23Pictures">#Pictures</a> <a class="tag" href="/search/?q=%23Flowers">#Flowers</a> <a class="tag" href="/search/?q=%23Plants">#Plants</a> <a class="tag" href="/search/?q=%23Camellias">#Camellias</a> <a class="tag" href="/search/?q=%23Locarno">#Locarno</a> <a class="tag" href="/search/?q=%23Ticino">#Ticino</a></p> 
...
<p>At the Godot Conf, at our last dinner the population breakdown was:<br />- 3 iPhone users<br />- 7 vanilla Android users<br />- 7 fully liberated Android, no Google users.</p><p>It is a crowd that vibes at a different frequency.</p><p>Background: I tried to privacy shame the Android folks at the table.</p> 
...
<p>The plan came together</p><p>Spread lies about UNWRA; cut the major donor long enough to make the life of remaining people miserable, build an expulsion pier and yeet them out</p><p>Take over the Gaza offshore oil fields without disturbance + New beach properties for wealthy Americans.</p><p><a href="https://x.com/maitelsadany/status/1771596788044083600?s=46" target="_blank" rel="nofollow noopener noreferrer" translate="no"><span class="invisible">https://</span><span class="ellipsis">x.com/maitelsadany/status/1771</span><span class="invisible">596788044083600?s=46</span></a></p> 
...
<a href="https://github.com/scripting/Scripting-News/issues/299">Braintrust query</a>: I have not been able to reliably get to a bunch of my sites that use HTTP this morning. For example, <a href="http://feeder.scripting.com/returnjson?feedurl=https://techfightclub.wordpress.com/feed/">feeder.scripting.com</a>, a site that I use to test feeds. Also <a href="http://xmlrpc.com/">xmlrpc.com</a>. It's possible that something broke overnight in my server. Or Digital Ocean is having a problem? Doesn't seem like it's something Google is doing to punish me for using HTTP, though that is always the first thing that comes to mind. I tried moving the XML-RPC site to a different server, but the problem follows it. No changes have been made to the site in years. Not exactly what I had planned to be digging into on a nice (but cold) Sunday morning in the mountains. I started a <a href="https://github.com/scripting/Scripting-News/issues/299">thread</a>, if you have any insights. At least scripting.com is still working, but it's not served through my software or Digital Ocean. 
...
<p>Gidget&rsquo;s inherited a lovely little blanket from an elderly family friend of Viv&rsquo;s whose beloved cat recently passed away. She said Gidget had better appreciate it because &ldquo;it was very special to Sooty&rdquo;. Thankfully, she does 😸</p>
<img src="https://www.jayeless.net/media/2024/03/gidget-blankie1.jpeg" alt="a tabby cat investigates (by sniffing) a small woollen blanket made up of red and black knitted squares" class="u-photo"><img src="https://www.jayeless.net/media/2024/03/gidget-blankie2.jpeg" alt="a view of the tabby cat from behind, who has sat on the blanket and is now cleaning the back of one leg" class="u-photo"><img src="https://www.jayeless.net/media/2024/03/gidget-blankie3.jpeg" alt="the tabby cat lying on the blanket and showing off her white belly" class="u-photo"> 
...
<ul>
<li>
<p><a href="https://lkml.org/lkml/2024/3/10/243">Linux kernel 6.8 released:</a></p>
</li>
<li>
<p><a href="https://github.com/tofuutils/tenv/releases/tag/v1.2.0">Release of tenv 1.2.0:</a></p>
</li>
<li>
<p><a href="https://lists.mindrot.org/pipermail/openssh-unix-dev/2024-March/041264.html">Release of OpenSSH 9.7:</a></p>
</li>
<li>
<p><a href="https://github.com/openai/transformer-debugger">The OpenAI project has opened Transformer Debugger:</a></p>
</li>
<li>
<p><a href="https://gitlab.gnome.org/GNOME/gtk/-/tags/4.14.0">GTK 4.14 with new engines for OpenGL and Vulkan:</a></p>
</li>
<li>
<p><a href="https://github.com/obsproject/obs-studio/releases/tag/30.1.0">OBS Studio 30.1 released:</a></p>
</li>
<li>
<p><a href="https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id%3D77417942e49017ff6d0b3d57b8974ab1d63d592c">The old NTFS driver &amp; Linux kernel 6.9:</a></p>
</li>
<li>
<p><a href="https://obsolescence.dev/pidp10">PDP-10 mainframe on Raspberry Pi 5:</a></p>
</li>
<li>
<p><a href="https://voidlinux.org/news/2024/03/new-images.html">Updating Void Linux installation builds:</a></p>
</li>
<li>
<p><a href="https://content.minetest.net/packages/ryvnf/mineclonia/">Update of Mineclonia 0.97:</a></p>
</li>
<li>
<p><a href="https://tile-os.com/">First release of TileOS:</a></p>
</li>
<li>
<p><a href="https://blogs.gnome.org/alicem/2024/03/15/libadwaita-1-5/">Release of Libadwaita 1.5:</a></p>
</li>
<li>
<p><a href="https://openela.org">Rocky, Oracle and SUSE will provide further support for the Linux 4.14 kernel:</a></p>
</li>
<li>
<p><a href="https://webkitgtk.org/2024/03/16/webkitgtk2.44.0-released.html">WebKitGTK 2.44.0 browser engine:</a></p>
</li>
</ul>
