...
<p>
Processing power isn't everything, of course: the 160MHz PA-7300LC does this with a TDP of 15W,<!-- http://cpudb.stanford.edu/processors/255.html --> while the 300MHz 603e displaces just four to six watts, and the 240MHz part (fabbed on the same 290nm process) is on the lower end of that range. In real world terms that translated to battery life that was at least twice as long on the 3400c.
<p>
...
Once the installation is complete, we simply execute <tt>./mae</tt> in <tt>/opt/apple/bin</tt>. The very first run requires us to accept the EULA; there is a specific binary for this and we'll look at it when we take the code apart a bit.
...
<p>
Two other hidden files are also present in this directory, <tt>.fs_cache</tt> and <tt>.fs_info</tt>, which maintain the virtual Mac's file and volume information respectively. <tt>.fs_cache</tt> in particular is very important as it is roughly the global equivalent of an HFS catalog file (and, like a real HFS catalog file, is stored on disk as a B-tree), storing similar metadata like type and creator, timestamps and so forth. This file is so important to MAE that Apple distributed a separate tool called <tt>fstool</tt> to validate and repair it, sort of like MAE's own Disk First Aid from the shell prompt.
<p>
You'll have also noticed above that the desktop database in <tt>spectre</tt> and <tt>opt</tt> is made up of <em>four</em> files. <tt>Desktop DB</tt> and <tt>Desktop DF</tt> are present as usual for the bundle database and Finder information respectively, but there are also two more files <tt>%Desktop DB</tt> and <tt>%Desktop DF</tt>, named exactly the same except for a percent sign sigil. This is the other way that resource forks can be represented in MAE, as AppleDouble. Here, the data fork and resource fork are split, with the percent sign indicating the resource fork.
<p>
Let's explore the MAE System 7.5.3 some more before we attempt to install anything.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh1hT3cbjgWIj6nj_EGl2aTQsn7AUJ0_qyK4JoSZ8yeie0BFc7OcmwkMNoaiEgtPtsUZm2-N3giG2n9rQXfqOQuxaoSHe6dD1opgtei2MrxqGVlubMluzBvbVN_QGw6FdS5UklvtDBDkGt2FF8TuEeRh4MZxfVfuLGBTKRAm_o1NEVuS8rkD41vooVsXpY/s1024/mae09.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh1hT3cbjgWIj6nj_EGl2aTQsn7AUJ0_qyK4JoSZ8yeie0BFc7OcmwkMNoaiEgtPtsUZm2-N3giG2n9rQXfqOQuxaoSHe6dD1opgtei2MrxqGVlubMluzBvbVN_QGw6FdS5UklvtDBDkGt2FF8TuEeRh4MZxfVfuLGBTKRAm_o1NEVuS8rkD41vooVsXpY/s320/mae09.xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiIX4sNRkWDUhVvjpjNpLPDRXFx651PvF_zjnTpDr61eOBOgeCuwsEl2scEvlUGomI0n2RX10FGnnj875WKe50sVvi-L0WDuyVsV7ZVPOa1ONwdQxkvKsYlpDwJBskF75ByxRAQ3IQphA7gS4oNlVKJ-snKfAMMqstxKh2qn6rqQcqlOI9zKIeeLWGR2G8/s1024/mae13.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiIX4sNRkWDUhVvjpjNpLPDRXFx651PvF_zjnTpDr61eOBOgeCuwsEl2scEvlUGomI0n2RX10FGnnj875WKe50sVvi-L0WDuyVsV7ZVPOa1ONwdQxkvKsYlpDwJBskF75ByxRAQ3IQphA7gS4oNlVKJ-snKfAMMqstxKh2qn6rqQcqlOI9zKIeeLWGR2G8/s320/mae13.xwd.png"/></a></div>

Here's my home directory and <tt>/opt</tt> as they appear in the Finder. <tt>/opt</tt> is read-only to my uid, so I can't write directly to it. If I had permissions, I could change them from the Permissions dialogue, which is MAE's equivalent of <tt>chown</tt>, <tt>chmod</tt> and <tt>chgrp</tt> all in one. You can also view the (composite) System Folder here and see that it looks pretty much like any other System Folder on any other Mac with the exception of the MAE Enabler.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsE


<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhuhFTWHZhB6UNMAXSs7JpOeiRbAobZHS2XuBBgAR0Hm-uRqwIUWb4CiDrbdZOX936b2HrTdrHye-sOu50D1JJNNOKwDONnsTrsFhcQGiYujqQLR0pgEJZKxkEpteYT2RwXVX1YTtJUAzcdT5c0MgZynND6KXIqNuN92LCBcVYQh-nARDAEyKRfzPSrJCo/s1024/mae20.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhuhFTWHZhB6UNMAXSs7JpOeiRbAobZHS2XuBBgAR0Hm-uRqwIUWb4CiDrbdZOX936b2HrTdrHye-sOu50D1JJNNOKwDONnsTrsFhcQGiYujqQLR0pgEJZKxkEpteYT2RwXVX1YTtJUAzcdT5c0MgZynND6KXIqNuN92LCBcVYQh-nARDAEyKRfzPSrJCo/s320/mae20.xwd.png"/></a></div>

Another interesting panel which is included is a bespoke version of <a href="https://wiki.preterhuman.net/SoftwareFPU">SoftwareFPU</a>. Since not all 68K Macs have floating point units, applications are supposed to use Apple's SANE IEEE-754 library which computes the result in software if no FPU is available. Not all software does this, of course (the Magic Cap 1.0 simulator comes to mind), and this is particularly relevant with Power Macs because the 68K emulator only provides a virtual 68LC040. SoftwareFPU, then, is very simple conceptually: it traps F-line instructions intended for the non-existent coprocessor and turns them into SANE calls. This is slow but it means certain software is able to run that otherwise could not.
<p>
The MAE SoftwareFPU, which Apple licensed from John Neil &amp; Associates and modified for MAE 3.0, goes a bit further. This version implements a fast path where 68K floating point instructions are directly forwarded to MAE, effectively making F-line traps into hypercalls. Apple estimated this was about 50 percent faster than using regular SoftwareFPU. That said, you'll notice that SoftwareFPU is <em>disabled</em>, which is the default. We'll come back to this when we benchmark the emulator.
<p>
In MAE 3.0, SANE was changed to directly use host FPU instructions (either SPARC or PA-RISC) for the most commonly performed floating point operations. This works for single and double precision and ran substantially faster than MAE 2.0, but it doesn't work for the 68K's 80-bit extended-precision type, where double precision operations are performed instead and converted (but with a corresponding loss of precision). The previous behaviour, where SANE is simply run under emulation, can be restored with the <tt>-sane</tt> command line option.
<p>
A better solution on Power Macs is <a href="http://www.ittybittycomputers.com/IttyBitty/PowerFPU/">Tom Pittman's PowerFPU</a>, which (where possible) uses PowerPC floating point instructions directly rather than SANE. All Power Macs have an FPU, so this works on all Power Macs, and is over ten times faster than SoftwareFPU.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEha5UlKeOdMoCvO70wKZgx9HiLwd-bceRPurV2BEHKUjUKrzYRIMBUr1nP3aMfQgpJef6fEVGcUkhhBqTwtAt7LBMQkDBlH5ZOQj7dt7P326_lGifAfSEn0Rt5J6n7he5oBdUtkwBAgpSDZ3-fF_INqKHrggYpJfrMJ7YWB0eXAzXqdNO1RXXk734b8OoM/s1024/mae17.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEha5UlKeOdMoCvO70wKZgx9HiLwd-bceRPurV2BEHKUjUKrzYRIMBUr1nP3aMfQgpJef6fEVGcUkhhBqTwtAt7LBMQkDBlH5ZOQj7dt7P326_lGifAfSEn0Rt5J6n7he5oBdUtkwBAgpSDZ3-fF_INqKHrggYpJfrMJ7YWB0eXAzXqdNO1RXXk734b8OoM/s320/mae17.xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgThgakizSweq-rgNHRg6MLonCxbuu3f92Te8I6Oj2iMtnBvTq8W7OO3dQErFFKjfRXOMYNh8ezz_4qtlczx9YbW08YRm3Fy0bIa2wMFj7GBRlu2LkrMK4mJ1kl8RgdshPlbzCM6mh7x4b33Et8DmWg5HoXCXYmCDC2JKyXTz2OGKqFwFGQ8JfE9U2XN5g/s1024/mae21.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgThgakizSweq-rgNHRg6MLonCxbuu3f92Te8I6Oj2iMtnBvTq8W7OO3dQErFFKjfRXOMYNh8ezz_4qtlczx9YbW08YRm3Fy0bIa2wMFj7GBRlu2LkrMK4mJ1kl8RgdshPlbzCM6mh7x4b33Et8DmWg5HoXCXYmCDC2JKyXTz2OGKqFwFGQ8JfE9U2XN5g/s320/mae21.xwd.png"/></a></div>

Normally this process requires a shell window, so you can also designate Unix-side executables that explicitly don't need one and will execute directly, like <tt>xclock</tt> or <tt>xcal</tt>.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjx_cuTwAaA3WrHNFvSa2Tzn5PRChe1HhN_i1JkxVq-4cDjmwz-FqfCGklonlACsAN3oQB6aB1z83t3JZxx5J8Ekgekg2yRVG1Lg6QH85sH8ULgFEP63Zx5W1Fcqmn7Ok-KVxjaEgaoQQ0_0C1968FBA-UmfeFP24PRZZsxJ9UOyWL2fnCbRBQaN90rY2A/s1024/mae22.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjx_cuTwAaA3WrHNFvSa2Tzn5PRChe1HhN_i1JkxVq-4cDjmwz-FqfCGklonlACsAN3oQB6aB1z83t3JZxx5J8Ekgekg2yRVG1Lg6QH85sH8ULgFEP63Zx5W1Fcqmn7Ok-KVxjaEgaoQQ0_0C1968FBA-UmfeFP24PRZZsxJ9UOyWL2fnCbRBQaN90rY2A/s320/mae22.xwd.png"/></a></div>

Regardless, no configuration of MAE is necessary to just open up random Unix executables. Here we're running the HP-UX build of the <a href="https://frodo.cebix.net/">Frodo Commodore 64 emulator</a>, which I installed in <tt>/opt</tt>. The terminal window opens, which is important to capture any standard error or output, but otherwise it runs normally outside of MAE.
<p>
That makes you can use the MAE Finder as ... your desktop. You could make MAE take up the entire screen by passing <tt>/opt/apple/bin/mae</tt> the appropriate <tt>-geometry</tt> option and setting the X resource <tt>Vuewm*mae*clientDecoration</tt> to none, effectively making it rootless, and Apple fully supported and documented doing so. Now you've got a virtual Mac that will launch your native X11 applications as well. Who needs CDE when you've got this?
<p>
We'll look at another standard control panel that MAE uses for a different purpose in a little while. Meantime, having made a basic survey of the emulator, it's now time to actually run software on it. A benchmark would be a good first test but to do that we need to actually <em>put</em> software on it.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhj0fnqXZr7o1_2_cAdL64hYWnr04DQA7PcvQe06KOMVbV82_o16QBlgH6dW2iS6EBuaHCl3ufVkq12kjFGDEcEY9pWI_6tgavKDYUKOr3UQ0PbQXS4fIyc72aVAHljrAXbvgu_b0xIW-zClNC2airjXqQJ9E3fYe4xclHDjGVLtS1CwEf6jiXIeT309uE/s4080/PXL_20250727_133731020.jpg" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="3072" data-original-width="4080" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhj0fnqXZr7o1_2_cAdL64hYWnr04DQA7PcvQe06KOMVbV82_o16QBlgH6dW2iS6EBuaHCl3ufVkq12kjFGDEcEY9pWI_6tgavKDYUKOr3UQ0PbQXS4fIyc72aVAHljrAXbvgu_b0xIW-zClNC2airjXqQJ9E3fYe4xclHDjGVLtS1CwEf6jiXIeT309uE/s320/PXL_20250727_133731020.jpg"/></a></div>

If this were any other Mac I was setting up, I'd get AppleTalk started (either via EtherTalk or LocalTalk) and then grab stuff from <tt>thule</tt>, my little 128MB Macintosh IIci running NetBSD and Netatalk for AppleShare. I have lots of basic software on here including useful INITs and CDEVs and essential tools like StuffIt Expander. It still runs NetBSD 1.5.2 because I had trouble getting regular AppleTalk DDP working with 1.6 and up, so it's a fun time capsule too.
<p>
But we don't have AppleTalk in MAE, so how are we going to get files from it? Easy: we're going to download the files from <tt>thule</tt> with FTP and put them into my home directory while MAE is running. The Finder will see the new files and incorporate them.
<p>
What about the resource forks? The fact that the files are being served by Netatalk from a non-HFS volume (i.e., BSD FFS) actually makes that easier. Netatalk natively stores anything with a resource fork as AppleDouble, depositing the resource fork itself as a separate file <a href="https://netatalk.io/docs/Special-Files-and-Folders">into a hidden directory <tt>.AppleDouble</tt></a>. We pull down both the data fork and the resource fork, rename the resource fork with a <tt>%</tt>, and move them both at the same time into my home directory. On the next Finder update, it sees the "whole" file and it becomes accessible.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh6-yzShMZPdqH2lo03oGzhWfEXYoM3ntwUW0dRPiXKdVGnHWe6kRX1DBF5D5ZTJHrsVwKUX5PHRSKYxDiDg_5OcJ7nXuIxi3wXUL6Bm5wfq8eyiHARkh7QMNmP3iwyMpGUSKiFb0kIQvBPRZzOeLLgP4q7WWyuNnFTVEoN3Mz5VWu1qybfWxs4Br1T5yw/s1024/mae25.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh6-yzShMZPdqH2lo03oGzhWfEXYoM3ntwUW0dRPiXKdVGnHWe6kRX1DBF5D5ZTJHrsVwKUX5PHRSKYxDiDg_5OcJ7nXuIxi3wXUL6Bm5wfq8eyiHARkh7QMNmP3iwyMpGUSKiFb0kIQvBPRZzOeLLgP4q7WWyuNnFTVEoN3Mz5VWu1qybfWxs4Br1T5yw/s320/mae25.xwd.png"/></a></div>

Ta-daaa. We now have StuffIt Expander 5.5.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg0I1Tt2KLzD2co24pIgRSa5604bf9V6Xu8985uJab7l2cJaGxpo-IMcEAnRFG8WgTf0KRJjN60z4WGRG1BCg_RUK-H9eykS-UeNGqKojYarTEqNSGr6e-wnwouF8eoQAtVM3KyLP74YxBud8cdQa4JMXugv14yXkZOIrGD6vYRC9lT_QOgp0G_DQg0vAo/s1024/mae26.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg0I1Tt2KLzD2co24pIgRSa5604bf9V6Xu8985uJab7l2cJaGxpo-IMcEAnRFG8WgTf0KRJjN60z4WGRG1BCg_RUK-H9eykS-UeNGqKojYarTEqNSGr6e-wnwouF8eoQAtVM3KyLP74YxBud8cdQa4JMXugv14yXkZOIrGD6vYRC9lT_QOgp0G_DQg0vAo/s320/mae26.xwd.png"/></a></div>

All resources transferred and it works perfectly. So that I'm not storing lots of Mac stuff in the root of my home directory, I made a new folder named <tt>Mac</tt> and moved StuffIt Expander there. We can now work with StuffIt archives and only have to download one file, which saves having to get the resource fork separately.
<P>
An alternative approach, especially if you <em>are</em> transferring a file directly from an HFS or HFS+ volume, is to turn it into AppleSingle first and copy that over; MAE will use the file as-is. Apple provided a tool for this in later versions of Mac OS X/macOS, though 10.4 and prior, arguably where it would have been most useful because those versions still support the Classic Environment, don't seem to have it. The best alternative there is <tt>/Developer/Tools/SplitForks</tt>, which doesn't do AppleSingle but does create separate AppleDouble data and resource fork files, so at least you can copy those. We'll get to a somewhat more automatic way of specifically handling Netatalk's AppleDouble directories a bit later.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEioeTbh_fbc9qCd3Uxul2APiRD_EwdRMbZUY4V1DtQgbcfhN_uVpRJs2aMpamp0GJPcubFQthpFgzlWg7MG5OvWRjRJkhMokLc_tvbuVAMNvwh5elp7xxjwHUk9kuX3p8P9q_U7zNWSoZuDI8Gzvwl9E0Brr0qvIFUIKNE4STo_mI07DqujZ0xEQ9pQYGI/s1024/mae27.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEioeTbh_fbc9qCd3Uxul2APiRD_EwdRMbZUY4V1DtQgbcfhN_uVpRJs2aMpamp0GJPcubFQthpFgzlWg7MG5OvWRjRJkhMokLc_tvbuVAMNvwh5elp7xxjwHUk9kuX3p8P9q_U7zNWSoZuDI8Gzvwl9E0Brr0qvIFUIKNE4STo_mI07DqujZ0xEQ9pQYGI/s320/mae27.xwd.png"/></a></div>

The corollary to "don't roll your own crypto" is "don't roll your own benchmark" but I did that <a href="http://www.floodgap.com/retrotech/mac/ahl/">over 23 years ago</a> and here we are. I wrote SieveAhl in Modula-2 using the unfortunately named <a href="https://www.sysecol2.ethz.ch/RAMSES/MacMETH.html">MacMETH compiler</a> just to be weird, rolling all the Toolbox calls by hand. It implements the Sieve of Eratosthenes and a modified version of the FPU-dependent Ahl's Simple Benchmark and issues a score relative to my Macintosh Plus which I have as a reference standard. The main advantage SieveAhl has over other benchmarks is that I wrote it intentionally to run on just about <em>any</em> Mac, even down to System 1.1 (tested in vMac). Here, I'm simply grabbing the StuffIt archive using Internet Explorer 5 for UNIX on the CDE side and saving it into the Mac folder.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgCptHgHBSsuboHIC6ZSwhb8Pxt-gKbpo4yub1DLPn327N7RGooJsL2R_vKS3hfmIRTexMBm9BRk1h5-qdyWLn7qrsFqMk4P-hw1VruSbptr5v0anhK57HbEs2QSJM9Veg92RBNESaXzYy5eEyWjHVS9zp9JFZdkFf0HHXAXqiqzmmj5R2hiUQZaBWao5M/s1024/mae28.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgCptHgHBSsuboHIC6ZSwhb8Pxt-gKbpo4yub1DLPn327N7RGooJsL2R_vKS3hfmIRTexMBm9BRk1h5-qdyWLn7qrsFqMk4P-hw1VruSbptr5v0anhK57HbEs2QSJM9Veg92RBNESaXzYy5eEyWjHVS9zp9JFZdkFf0HHXAXqiqzmmj5R2hiUQZaBWao5M/s320/mae28.xwd.png"/></a></div>

UnStuffing pretty much just works in MAE. It's not especially fast but unStuffing large <tt>.sit</tt> files isn't too swift on other 68K systems either. We now have a Mac directory that looks like this from the Unix side:
<p>
<div class="tx"><pre>
...
<p>
Our newly created files in the <tt>SieveAhl Folder</tt> are now AppleSingle, for example the readme file:
<p>
<div class="tx"><pre>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjrk4pnZya5ToRmGRQYvK6Ne3bGv_VbOUZ_3dJ0tMw9-f27ck_FkJDKE1wBCQcUiM71rYvOl528UFcA9oD2hbZhVMMD2VrtJtLPhhFK1iFGAsh8gVdGUTukonNddwBliWdR_8pkQk2IW3SyP_2CDEDBZdQ1DuqqvH4Im4ioiTFn_BWrvH4MbZ71y5RwB_I/s1024/mae29.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjrk4pnZya5ToRmGRQYvK6Ne3bGv_VbOUZ_3dJ0tMw9-f27ck_FkJDKE1wBCQcUiM71rYvOl528UFcA9oD2hbZhVMMD2VrtJtLPhhFK1iFGAsh8gVdGUTukonNddwBliWdR_8pkQk2IW3SyP_2CDEDBZdQ1DuqqvH4Im4ioiTFn_BWrvH4MbZ71y5RwB_I/s320/mae29.xwd.png"/></a></div>

The About box, for posterity.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjx6Z0QlVTE9MT80z6QzKO7Hm0pF_IBqHc4y4SM29mzvtFXkjgeqMPIORY61YufhStqS2-QzvXUocr1a92MKMKFlu3Ffc3pGk1_qnZsYu3PaDI4DVbLc0l-H4Miv3hVSYe-DHqUyqUMLAuiAxZ0iNMMfgAyJkH84XNaPSAdwIg3PZ8LV394hw3ff5csdAg/s1024/mae30.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjx6Z0QlVTE9MT80z6QzKO7Hm0pF_IBqHc4y4SM29mzvtFXkjgeqMPIORY61YufhStqS2-QzvXUocr1a92MKMKFlu3Ffc3pGk1_qnZsYu3PaDI4DVbLc0l-H4Miv3hVSYe-DHqUyqUMLAuiAxZ0iNMMfgAyJkH84XNaPSAdwIg3PZ8LV394hw3ff5csdAg/s320/mae30.xwd.png"/></a></div>

Each SieveAhl benchmark asks for the number of runs (too few on a fast system impairs accuracy due to the timekeeping method used). Our integer run with the Sieve clocks in at 4,701% (i.e., 4.7x) the speed of our reference ~8MHz Mac Plus. This is a Modula-2 version of the implementation originally published in <i>Byte</i> in September 1981. It iterates over the interval 0-8190, in which 1,899 primes are expected.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj_sC5RmeVBWJEh07v44MaeRq5YnQ1pea9EZ5nPDeIax5NEW4ri_G9Ns2hFfU0KjaMb1fHLP2UoupdO1zUAtKUhOsQqeHGrFl3iKSZLU250YRHB6DgnxmkQ0nJeur6i80o2HGXmXZVO1r-PodmfDdOkTEVNj2k9w3uHjkgY3ofdzi0h3O2u69qrz0TJi4A/s1024/mae31.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj_sC5RmeVBWJEh07v44MaeRq5YnQ1pea9EZ5nPDeIax5NEW4ri_G9Ns2hFfU0KjaMb1fHLP2UoupdO1zUAtKUhOsQqeHGrFl3iKSZLU250YRHB6DgnxmkQ0nJeur6i80o2HGXmXZVO1r-PodmfDdOkTEVNj2k9w3uHjkgY3ofdzi0h3O2u69qrz0TJi4A/s320/mae31.xwd.png"/></a></div>

The FPU test is based on David Ahl's Simple Benchmark from <i>Creative Computing</i>, intended originally to evaluate performance and precision differences between various microcomputer BASIC implementations. We don't care about the accuracy or randomness values his benchmark would compute (well, we don't care <em>much</em>), so we just compute those and throw them away. This gets 4,863% the speed of a Mac Plus, which we would expect to be roughly the same because we have no floating point hardware. Repeated runs of both tests were nearly identical.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj3NTwb2syguc5KTAX41ICEdZ6QY7Sh355Z_UwcpEpw0Es7IhDVStaQ6UxMrW80bQ09gLOvrQ8Gq-EyldSAdg4T8Tqpr4gLM5eHy6xR-iEWO3gkzuXeFAVpdOcU8H8isDyT9jECvDFfbS4nzMUYZ1V-I0rjlYNtZIIcdmAi1E1Le6w-DQKCN6OBpj9cdtg/s1024/mae32.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj3NTwb2syguc5KTAX41ICEdZ6QY7Sh355Z_UwcpEpw0Es7IhDVStaQ6UxMrW80bQ09gLOvrQ8Gq-EyldSAdg4T8Tqpr4gLM5eHy6xR-iEWO3gkzuXeFAVpdOcU8H8isDyT9jECvDFfbS4nzMUYZ1V-I0rjlYNtZIIcdmAi1E1Le6w-DQKCN6OBpj9cdtg/s320/mae32.xwd.png"/></a></div>

I mentioned that SoftwareFPU was turned off, so let's turn it on and see if it makes any difference to the floating point score. It does, but roughly only about 1% (!) better. However, it should be kept in mind that Apple's advertised 50 percent improvement was against using <em>regular</em> SoftwareFPU, not against using it at all. Additionally, MacMETH generates well-behaved code that calls SANE as it should and doesn't emit floating point instructions.
<p>
How does this compare to a real 68LC040? Conveniently, we have one handy to try it out on!

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhZsoN8NhSgFLwnDqr9dY5zhuq8invXp-FGKeq8E_MIftTmUYTo-308vgHTAEtV6WNJr5W9mLvrBF0z0Z1WbvdkMO0hsve2fh_xz4byNhdidjM4rzcArBUzHj4l6Jnw0UG4PXcn7LjLD-Ca1NNrWfQh19s4aydj1VYZhopK0WuNnYMXRL7JsBS6NjAonCs/s4080/PXL_20250726_151830840.jpg" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" height="320" data-original-height="4080" data-original-width="3072" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhZsoN8NhSgFLwnDqr9dY5zhuq8invXp-FGKeq8E_MIftTmUYTo-308vgHTAEtV6WNJr5W9mLvrBF0z0Z1WbvdkMO0hsve2fh_xz4byNhdidjM4rzcArBUzHj4l6Jnw0UG4PXcn7LjLD-Ca1NNrWfQh19s4aydj1VYZhopK0WuNnYMXRL7JsBS6NjAonCs/s320/PXL_20250726_151830840.jpg"/></a></div>

This is <tt>rintintin</tt>, my PowerBook 540c with a 33MHz 68LC040 and 12MB of RAM running Mac OS 7.6.1, and the most powerful Blackbird PowerBook sold in the United States (the later Japanese 550c is the same speed, but with a full 68040 and FPU). It was the first PowerBook with any '040 processor, stereo speakers, on-board Ethernet (via AAUI), a trackpad instead of a trackball, twin battery bays and a full-size keyboard. The PowerBook 520/520c and 540/540c came out just a couple months after the first Power Macs and Apple placed the processor onto a daughtercard as a promise that it could be eventually upgraded. As such, the "Ready for PowerPC upgrade" sticker came on these models from the factory, though this particular one is a slightly larger reproduction I printed up a few copies of so I could surreptitiously slap them on the Intel Macs at the Apple Store. Apple nevertheless greatly underestimated demand for the line, mistakenly believing people would rather wait for what eventually was the PowerBook 5300, and the Blackbirds were chronically short-stocked for months.
<p>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgmNWIVBVn30wsi-fIRONZaUyEjuWFS0hy9c5zHST05xjA-7hvS4yUDm7TsR9BM_svmzYG1X44hEWRGc8DRzoYrC5Fm1kNdKKL9BObGA-GoGSl-I95-kfOqFZeYIBovueo3oLljejmSfXswUSPZAGgDBuo7-x9V1j3oqoamn0r9VvlpFTjlxHibtdLIkn0/s1920/vlcsnap-2025-07-26-14h30m45s290.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="1080" data-original-width="1920" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgmNWIVBVn30wsi-fIRONZaUyEjuWFS0hy9c5zHST05xjA-7hvS4yUDm7TsR9BM_svmzYG1X44hEWRGc8DRzoYrC5Fm1kNdKKL9BObGA-GoGSl-I95-kfOqFZeYIBovueo3oLljejmSfXswUSPZAGgDBuo7-x9V1j3oqoamn0r9VvlpFTjlxHibtdLIkn0/s320/vlcsnap-2025-07-26-14h30m45s290.png"/></a></div>

The Blackbird PowerBooks were also movie-famous, most notably in the first 1996 <i>Mission: Impossible</i> movie with Tom Cruise and Jon Voight. A regular Blackbird in the standard two-tone grey, most likely a 540c, was what Luther used to block the NOC list transmission on the TGV in the third act.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEglK3FrJk510RJhX_UrAtRUQ_TyGQ7cDictC44CNnL0NNiDVRSa9V-dA006ttbjhGzdOhVLxGWZmmAjZXNKMfoLT6fePYgO_uGF6YCMeWgvdexMblRnYQRNfvgCRBnpuKQ5mF4BiiHFZr1S-jONfTIOiWIHTZBw-7_2PKn2yPl36FgcUwoaulvivvJGuSA/s1920/vlcsnap-2025-07-26-14h18m52s997.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="1080" data-original-width="1920" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEglK3FrJk510RJhX_UrAtRUQ_TyGQ7cDictC44CNnL0NNiDVRSa9V-dA006ttbjhGzdOhVLxGWZmmAjZXNKMfoLT6fePYgO_uGF6YCMeWgvdexMblRnYQRNfvgCRBnpuKQ5mF4BiiHFZr1S-jONfTIOiWIHTZBw-7_2PKn2yPl36FgcUwoaulvivvJGuSA/s320/vlcsnap-2025-07-26-14h18m52s997.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhJI4PTCWT-5KggX-g58MW-wNmXX9H-I_79JJPHX45S38IYaWAxJpthsKLc53w_XWgol5iWBznisVRO_8n7t1jimsIGr8miTGf4SNFltw7FJVGyrSRcD26fG3SaWLczpXmP8NB7tU3qcaLTmG0ZUaNPC-_RU2duY3dJR8xY1_aIaSVVrLhQYtb4DeF2m1U/s4080/PXL_20250726_214117502.jpg" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="3072" data-original-width="4080" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhJI4PTCWT-5KggX-g58MW-wNmXX9H-I_79JJPHX45S38IYaWAxJpthsKLc53w_XWgol5iWBznisVRO_8n7t1jimsIGr8miTGf4SNFltw7FJVGyrSRcD26fG3SaWLczpXmP8NB7tU3qcaLTmG0ZUaNPC-_RU2duY3dJR8xY1_aIaSVVrLhQYtb4DeF2m1U/s320/PXL_20250726_214117502.jpg"/></a></div>

... they also match the Blackbirds', making it either a 550c (which was, in fact, black) or a spray-painted 520c or 540c. Since Apple wasn't actually selling <em>any</em> Blackbird laptop anymore by the time the movie came out, neither computer's model badge is ever visible, though you can at least see a rainbow apple on Luther's.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh


<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiWbcQKgLVfN3s7y-vMILb0xT65yrl0bDc7b6rCB7muHuG1HPyVgI5HPsddIrtaw_qSIjopLXnDDLrtux6iwPDYnJIaq9WwJevh5EMQq6JsJGkVSGgh5T1_4tdFqopSCZY44JE_mKQFzD_S_vmKnGriFCB1sYwEQXncBEYa6B0uZ-bwg_-2WG1QIu12UTY/s1024/mae35.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiWbcQKgLVfN3s7y-vMILb0xT65yrl0bDc7b6rCB7muHuG1HPyVgI5HPsddIrtaw_qSIjopLXnDDLrtux6iwPDYnJIaq9WwJevh5EMQq6JsJGkVSGgh5T1_4tdFqopSCZY44JE_mKQFzD_S_vmKnGriFCB1sYwEQXncBEYa6B0uZ-bwg_-2WG1QIu12UTY/s320/mae35.xwd.png"/></a></div>

MacLynx starts up and shows the default on-disk home page. This is in fact a good test for MAE specifically because to do something like view Hacker News or Lobste.rs we need to change <tt>lynx.cfg</tt> to point to our local <a href="/search/label/crypto%20ancienne">Crypto Ancienne TLS 1.3 proxy server</a>. However, we don't have a proper text editor installed other than SimpleText.
<p>
...
<p>
You'll notice that all the text files &mdash; the readmes, <tt>index.html</tt>, <tt>lynx.cfg</tt> and <tt>lynxrc</tt> &mdash; got separate resource forks as AppleDouble, but the main executable did not. Now, the smart ones among you will say, "But wait! The SieveAhl readme file is text, and it was AppleSingle!" That's right &mdash; except <em>that</em> file's text is all stored in styled text resources and there's nothing in the data fork at all. MAE seems to content-sniff files to figure out what to do with them, so BinHex files (which are valid text) will be treated as a text file and made AppleDouble, but a read-only SimpleText file with nothing in the data fork will be treated as a binary and made AppleSingle. The AppleDouble control panel allows you to always force storing files as AppleDouble with specific applications and the separately distributed <tt>asdtool</tt> will convert a Mac file between AppleSingle and AppleDouble from the shell prompt.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi-24BGaE9cQRXWc5RbyKeENew1b4K95PFIh4Z44eQrpAWM6L7AgSQGCBBGB6E0f7EZJXHJMdrq4MIfti1_KoN5_z6J1lDr0o8nWtHovggTgQCI2TjVjDFtuhVNHrv-6tjcTKbmtli1QsCmpMpX8tSb2zhX9txUtmYz_Pq_jaiwY1vGIlKH26Z2wxQGbEk/s1024/mae37.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi-24BGaE9cQRXWc5RbyKeENew1b4K95PFIh4Z44eQrpAWM6L7AgSQGCBBGB6E0f7EZJXHJMdrq4MIfti1_KoN5_z6J1lDr0o8nWtHovggTgQCI2TjVjDFtuhVNHrv-6tjcTKbmtli1QsCmpMpX8tSb2zhX9txUtmYz_Pq_jaiwY1vGIlKH26Z2wxQGbEk/s320/mae37.xwd.png"/></a></div>

The upshot is that we now have a file we can simply edit from the Unix side with <tt>vi</tt> or, for the mentally deranged, <tt>emacs</tt> &mdash; and the resource fork will remain undisturbed. With MacLynx thus configured for the proxy server, we can view modern HTTPS sites inside MAE no problem.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiYrXs4hK40tyxUe8roZ3Lq9fUANF-2ac_U3sl1y0_hrz5u-VQ77DfB9DlKjtf2dAWanOc5hmhPOyKAdGEfPx4S2zGdRWCchKyx-enuioeW1GFiNl3TrWCa6NwV8YzVtg-0NNiSxJkVxj1zY9HzMqjytqi-cFMulJdr8NEi60VCApUJn4yry2wC0bk4bPQ/s1024/mae38.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiYrXs4hK40tyxUe8roZ3Lq9fUANF-2ac_U3sl1y0_hrz5u-VQ77DfB9DlKjtf2dAWanOc5hmhPOyKAdGEfPx4S2zGdRWCchKyx-enuioeW1GFiNl3TrWCa6NwV8YzVtg-0NNiSxJkVxj1zY9HzMqjytqi-cFMulJdr8NEi60VCApUJn4yry2wC0bk4bPQ/s320/mae38.xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhQq3zXqubIGmFzBZUlYmvEEQtHoHQHvd2s_Ke9sOyCsbfF9iSyx8jJudm3wE7ulFSRngbej7Z6oL7Ppk1GANUABWnpNRwn26ZA9QjTtbv6pepGdNsaaBRjiuz_bc1KInCc0VPzWe6ltTWB08F9_RWwq6FajHBxpD-joIKFfCj0XCW3xu3eQPYvtNIozD8/s1024/mae39.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhQq3zXqubIGmFzBZUlYmvEEQtHoHQHvd2s_Ke9sOyCsbfF9iSyx8jJudm3wE7ulFSRngbej7Z6oL7Ppk1GANUABWnpNRwn26ZA9QjTtbv6pepGdNsaaBRjiuz_bc1KInCc0VPzWe6ltTWB08F9_RWwq6FajHBxpD-joIKFfCj0XCW3xu3eQPYvtNIozD8/s320/mae39.xwd.png"/></a></div>

But this is also something MAE handles differently: instead of moving it, by default it creates an alias. (Aliases in MAE are still aliases, not symbolic or hard links, though a previously created symbolic link will also look like an alias.) You can copy the file by dragging it to the desktop with the Option key held down, but there's no way to indicate you want to <em>move</em> it. That almost sounds like that the MAE desktop doesn't belong to any MIV even though it is, in fact, part of the MIV for your home directory and that's where we had StuffIt Expander:
<p>
<div class="tx"><pre>
...
<p>
Our next set of programs will be TattleTech 2.8 and <a href="http://gestlab.free.fr/gestlab/glab_us.html#Top">Gestalt.Appl</a> so we can see what's going on under the hood. There are some surprises here.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgTF-_25W_A_1SjPjqdK65MNNTudvNX0B3q1r3XJRObABtc9L15hHKNxb9jpikiV0pClfuKlmH1DPtDigE7l1tfbb0kwvGFnnfzwN18lysAJqAlc2HERwVWMZGSt9B-PtBgo6Xv45nYUH-iWVwi6ia6fNwCBxdpSxQIAohUhhBhixekqJAoQrK-gGRTe0Q/s1024/mae40.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgTF-_25W_A_1SjPjqdK65MNNTudvNX0B3q1r3XJRObABtc9L15hHKNxb9jpikiV0pClfuKlmH1DPtDigE7l1tfbb0kwvGFnnfzwN18lysAJqAlc2HERwVWMZGSt9B-PtBgo6Xv45nYUH-iWVwi6ia6fNwCBxdpSxQIAohUhhBhixekqJAoQrK-gGRTe0Q/s320/mae40.xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhNbTWPEIZCAfPPGW6J_MhiJ7jYSg3OV8El1Wleu891MkPomRuvJW-9BI4m1rs3Fpw_8rLYKmQlXltLsHmjQP5I5k0281wF3IZ_PWhAhpoh6HdqP-CxB6akKJbRtHdhC870h_JriVnt89dezTVmE8Gv7BDfXlXbTiP6WA7XqCv9a-OQr9nZcg08-lcchio/s1024/mae41.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhNbTWPEIZCAfPPGW6J_MhiJ7jYSg3OV8El1Wleu891MkPomRuvJW-9BI4m1rs3Fpw_8rLYKmQlXltLsHmjQP5I5k0281wF3IZ_PWhAhpoh6HdqP-CxB6akKJbRtHdhC870h_JriVnt89dezTVmE8Gv7BDfXlXbTiP6WA7XqCv9a-OQr9nZcg08-lcchio/s320/mae41.xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgbG0qWRRr6g_bsyAt6DbhlpnvpKolS2uelvFzjbwDvq5GO0hL_mt-GCs-JuSaapSj5pvZ5YIOtYZpmux-SfN-nGqeOBlSYOauzGPW9vWoNPoPe-a7-Xstf7iOA9KK67xnyFceY_x-UI6I1DQ1z-imX1aaLjV3HChj5p6WOJj_snGTvWYTUgKnjf7JpFbA/s1024/mae42.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgbG0qWRRr6g_bsyAt6DbhlpnvpKolS2uelvFzjbwDvq5GO0hL_mt-GCs-JuSaapSj5pvZ5YIOtYZpmux-SfN-nGqeOBlSYOauzGPW9vWoNPoPe-a7-Xstf7iOA9KK67xnyFceY_x-UI6I1DQ1z-imX1aaLjV3HChj5p6WOJj_snGTvWYTUgKnjf7JpFbA/s320/mae42.xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj99o0HcLYWySkXh8-ZRmm-SZnWI6Iy0t34A-OLzHk73-JhuFzQcFf7SaU2Ko-s7uKhm4nFstv79_Y4hrjx5HBdqAHMslkxcIlCzKchosYLeWP4p-7AIqk_ma8FlFMXTw9G7-AXvmTnQDb9z0apjyQ9BCivtbOXkHhBo31OE3s9fEkXEnvRdsZA5ZPyiso/s1024/mae43.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj99o0HcLYWySkXh8-ZRmm-SZnWI6Iy0t34A-OLzHk73-JhuFzQcFf7SaU2Ko-s7uKhm4nFstv79_Y4hrjx5HBdqAHMslkxcIlCzKchosYLeWP4p-7AIqk_ma8FlFMXTw9G7-AXvmTnQDb9z0apjyQ9BCivtbOXkHhBo31OE3s9fEkXEnvRdsZA5ZPyiso/s320/mae43.xwd.png"/></a></div>

A single virtual NuBus slot is present. This is the emulated MAE video card ("Rev 2.0") and carries a revision date of June 13, 1994. The <tt>_L</tt> at the end of the <tt>Device sResource Name</tt> is significant because <tt>/opt/apple/bin/macd</tt> defines <em>six</em> such resources: <tt>Display_Video_Apple_MAE_S</tt>,
<tt>Display_Video_Apple_MAE_M</tt>,
<tt>Display_Video_Apple_MAE_L</tt>,
<tt>Display_Video_Apple_MAE_F</tt>,
<tt>Display_Video_Apple_MAE_C1</tt> and
<tt>Display_Video_Apple_MAE_C2</tt>. These apparently correlate to specific resolutions, namely (in the order they appear) "512 x 342 (9" Macintosh)",
"640 x 480 (14" Macintosh)",
"832 x 624 (17" Macintosh)",
"864 x 864 Resolution",
"640 x 800 Resolution" and
"640 x 640 Resolution". Since we're at 832x624, we get the <tt>_L</tt> (presumably small, medium, large, full and two custom?) "card." The emulated DeclROM used by these virtual cards is part of the big blob stored in <tt>/opt/apple/lib/engine</tt>, along with the Toolbox ROM and other goodies. We'll come back to this when we explore its Gestalt selectors.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsE
xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiO3UMKPU7-UQAWFdugNuGoEEo8tkwz_gHDtG7EJ0v4wGRGuP42pPMu2oySNTDpE1tfU2jtMprUk3R6rIaosSx0dCMcBQ7V12h_mL8W7lz26t7gduHokS8oveP4BZ5sJpa6BCVsASIDy6Jad1jlCVXF-4g1bsSpC9IruOnqdLVQV-RigWxSFbHGyaKoopw/s320/mae47.xwd.png"/></a></div>

A/UX is indicated as not present despite its provenance, CloseView is present (but again in a special "MAE 3.0" version), and the Code Fragment Manager isn't. Although CFM-68K was of course a thing, Apple had <a href="https://tidbits.com/1996/12/02/disable-the-cfm-68k-runtime-enabler/">deprecated it for 68K</a> in 1996.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiHh0OL-5lGuiGzv_P6udt3VMjGKmiaVZBBIBFKFCJWfpDy0QZFXjzo6-HdIywv6dFzLWg7lqXNbBa8MrKJlkTTP3ami4nwktv4CbnMem56wa_ml_he1Ro4DovJ5t5pPjFDdPFDz5CKfm2VXwpphQfFpnmwVwM5OXhBbZhVUObGPOL8R6WyAIswO42WI8o/s1024/mae48.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiHh0OL-5lGuiGzv_P6udt3VMjGKmiaVZBBIBFKFCJWfpDy0QZFXjzo6-HdIywv6dFzLWg7lqXNbBa8MrKJlkTTP3ami4nwktv4CbnMem56wa_ml_he1Ro4DovJ5t5pPjFDdPFDz5CKfm2VXwpphQfFpnmwVwM5OXhBbZhVUObGPOL8R6WyAIswO42WI8o/s320/mae48.xwd.png"/></a></div>

The PPC (Process-to-Process Communications) ToolBox is also present, which we last exploited to <a href="/2023/11/the-apple-network-servers-all-too.html">allow the Apple Network Server to numbercrunch for connected clients</a>. It should be possible to do something similar with MAE and have the local host do the work, but there are no local AppleTalk interfaces or headers to compile against.
<p>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi1R3F6Oh5TqXiyUmRS9qp4RHQh0ZFliey7ng6ipU2pFe5GsbPowjrquaVjDrn-PsnDDmT_FlDILQER0VjrRWXi7DXa4nqSc2bfMYGsp0vXTTIqp_WQ6T0jP_2JdyZNbNyxW1ARtQVotSDWUnlhMN02HDyUJ3q5lySrz9SNrDn3QiZ_xtndzrhN69lHWRY/s1024/mae49.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi1R3F6Oh5TqXiyUmRS9qp4RHQh0ZFliey7ng6ipU2pFe5GsbPowjrquaVjDrn-PsnDDmT_FlDILQER0VjrRWXi7DXa4nqSc2bfMYGsp0vXTTIqp_WQ6T0jP_2JdyZNbNyxW1ARtQVotSDWUnlhMN02HDyUJ3q5lySrz9SNrDn3QiZ_xtndzrhN69lHWRY/s320/mae49.xwd.png"/></a></div>

It's also worth pointing out that there is no Speech Manager. Apple specifically mentions the Speech Manager as incompatible in the MAE documentation, although it doesn't explain why. If an application installs it anyway, such as HyperCard, you can make MAE start with extensions off by passing <tt>-noextensions</tt>. 

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhTAkWd1EHIm_IvgDagYMlmd8KzY6EdVF8Axe15NxX7CgZTV4hktDYsiMK6qjnj5nCFnAI4o8GqEedne7dvph5Oy9OouJPNxZWzvt7ZNc17yxZxJRdPUAQQ5Awoow25Evswy6K2P2ZCOInp-N3iB0GZviF2eJERddEBIxQCQwogeIXpjtrLmAx89uwwoEM/s1024/mae50.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhTAkWd1EHIm_IvgDagYMlmd8KzY6EdVF8Axe15NxX7CgZTV4hktDYsiMK6qjnj5nCFnAI4o8GqEedne7dvph5Oy9OouJPNxZWzvt7ZNc17yxZxJRdPUAQQ5Awoow25Evswy6K2P2ZCOInp-N3iB0GZviF2eJERddEBIxQCQwogeIXpjtrLmAx89uwwoEM/s320/mae50.xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhU7MJEoOakvy_LYNhTKGSomROAtUPbbDvwtWVocYYvah2oQUkhCb-v0LaIYCu7P5RSUDjASHxmc4f9ArFiC00cvjivMsB6f5MXAxwtjzBwvK0mvNsn_jpoZp1mUMeUFcYSH4SVIwZE9USa_lAs_bw6RskscqknMBe1cHEVUyAkBn1VGU8ZBC_j5cmFU8I/s1024/mae51.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhU7MJEoOakvy_LYNhTKGSomROAtUPbbDvwtWVocYYvah2oQUkhCb-v0LaIYCu7P5RSUDjASHxmc4f9ArFiC00cvjivMsB6f5MXAxwtjzBwvK0mvNsn_jpoZp1mUMeUFcYSH4SVIwZE9USa_lAs_bw6RskscqknMBe1cHEVUyAkBn1VGU8ZBC_j5cmFU8I/s320/mae51.xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhQC-B-p0avmbPEoUOd9enSdjtgWubEZWyklYhEZHjxoNatdQ8M230gFBabMMyNVl17tNIH-0FEi0JwZYmcApLcwB9XbfR2VpQYoEMAE1NfIYemBpMZL1eVRg_4I8QX5bN6wL4If56fOOFc5bG3dkUdWbewek9xedDzAeLWFlHpQQRRLZ_jJ1LEg0itIEY/s1024/mae52.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhQC-B-p0avmbPEoUOd9enSdjtgWubEZWyklYhEZHjxoNatdQ8M230gFBabMMyNVl17tNIH-0FEi0JwZYmcApLcwB9XbfR2VpQYoEMAE1NfIYemBpMZL1eVRg_4I8QX5bN6wL4If56fOOFc5bG3dkUdWbewek9xedDzAeLWFlHpQQRRLZ_jJ1LEg0itIEY/s320/mae52.xwd.png"/></a></div>

Now for some Gestalt selectors of note. One I'm going to point out immediately is the <tt>cith</tt> selector ("Sith"? Darth Mac?), which is unique to MAE and is conveniently set to $00000304 (i.e., major version 3, minor version 4). While I don't have MAE 1.0 here to test with, Ren&eacute; Ros indicates in his Gestalt reports that it <a href="http://www.rgaros.nl/gestalt/chapters/ch-19.html">has a <tt>cith</tt> value of 0</a>, though it does exist there too. I don't know what version MAE 2.0 reports but I'm sure someone is firing it up right now to find out and will post in the comments.
<p>
To more easily decipher the others we'll turn to Gestalt.Appl and I'll point out the highlights.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjxA0s_vMd4Frdln5WvhpJWJmP5lDcNuxIfmBiOWpeb_wDYCNhHawJbvAXAMstuleXo3Dw2TYJmG4qw8vd1lqG3UeUIyHyBnrRor6NAFyr1T2N8fCfekA5rp7aC96xXuFKEBtSpUX1I9LK6js2aQuFFf9OwZehvmcF-aPbB_aF3XP8VtpNZx2qpNGzv6eY/s1024/mae53.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjxA0s_vMd4Frdln5WvhpJWJmP5lDcNuxIfmBiOWpeb_wDYCNhHawJbvAXAMstuleXo3Dw2TYJmG4qw8vd1lqG3UeUIyHyBnrRor6NAFyr1T2N8fCfekA5rp7aC96xXuFKEBtSpUX1I9LK6js2aQuFFf9OwZehvmcF-aPbB_aF3XP8VtpNZx2qpNGzv6eY/s320/mae53.xwd.png"/></a></div>

<tt>micn</tt> is not interesting for the icon (just generic Mac) but rather the string shown, which is a <tt>STR#</tt> resource indexed by the value of <tt>mach</tt> (-16395). The string is "Macintosh ApplicationEnvironment" [sic].

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEilW4MqlaqpDqVEg4oTuat9ODHqd-74n_DV06RDn3gOFmNkhFoV9U4uReE50FldSwk0C9NZhfmVdeB7rXFlsIBSIcZwx5nZ7w6fh8ZMhnR5IpLcLK3h9EyYmdJErypTwMxhaxm7uLWKaN80TiK3KcrysPI6xGU2pLFgVSf4Us0WbnxYICvMQ54CVQlxxAQ/s1024/mae54.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEilW4MqlaqpDqVEg4oTuat9ODHqd-74n_DV06RDn3gOFmNkhFoV9U4uReE50FldSwk0C9NZhfmVdeB7rXFlsIBSIcZwx5nZ7w6fh8ZMhnR5IpLcLK3h9EyYmdJErypTwMxhaxm7uLWKaN80TiK3KcrysPI6xGU2pLFgVSf4Us0WbnxYICvMQ54CVQlxxAQ/s320/mae54.xwd.png"/></a></div>

There is no MMU indicated in "<tt>mmu </tt>" (note space), but this isn't a surprise for an emulator. Consequently, there is also no virtual memory support within MAE (the host is supposed to handle that).

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhDi3XTIAMVQkZCpxldKSifNS4QFMBcVwhWm2yxC3EuRRuQW0NvxuAw71Pytkpdm4oDdWfYpXTYk3A6j_CmsaB3dGMMbZJjIW_d0ZOXzblnsbMDJmSUx-yS3kNyq6LK0vta7Jw2be7fQwCAVUwE16wW_UwAdICgImAG8FJ03GMJPeXEGRC9YuEJpMFwlzU/s1024/mae55.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhDi3XTIAMVQkZCpxldKSifNS4QFMBcVwhWm2yxC3EuRRuQW0NvxuAw71Pytkpdm4oDdWfYpXTYk3A6j_CmsaB3dGMMbZJjIW_d0ZOXzblnsbMDJmSUx-yS3kNyq6LK0vta7Jw2be7fQwCAVUwE16wW_UwAdICgImAG8FJ03GMJPeXEGRC9YuEJpMFwlzU/s320/mae55.xwd.png"/></a></div>

The ROM version (<tt>romv</tt>) is more interesting. Although a great many Old World Mac ROMs are tagged as version 1917, the particular ROM that MAE is using is from the Quadra 660AV and 840AV because we can find its checksum (<tt>5b f1 0f d1</tt>) and version (<tt>07 7d</tt>) at offset $001c0000 in <tt>/opt/apple/lib/engine</tt>. No other valid checksum and version appears anywhere else in this file, and no true <s>Scotsman</s> Macintosh LC would have used a ROM that recent. Thus, if you get a Gestalt ID of 19 but a ROM version of 1917, that's a pretty good indication you're running under MAE. Ren&eacute;'s list also shows a ROM version of 1917 for MAE 1.0, so MAE 2.0 almost certainly does as well.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEigabg4FvLAVcwdvHOG9qzSw2VGHQO-pyocP-qzLSBhdX8clvUnh_-v9_AdXnrseSQTnDYwK7khv_lzJEEjuyxu82Ultuwx4yNocYsuF0ujf7Ak3s5MPxakCgjppiFN5Z7RJLan-suhjP66EVyQk98mum3orD0y2KOMopumapj-A24EVDiAawxvqLyW6pU/s1024/mae56.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEigabg4FvLAVcwdvHOG9qzSw2VGHQO-pyocP-qzLSBhdX8clvUnh_-v9_AdXnrseSQTnDYwK7khv_lzJEEjuyxu82Ultuwx4yNocYsuF0ujf7Ak3s5MPxakCgjppiFN5Z7RJLan-suhjP66EVyQk98mum3orD0y2KOMopumapj-A24EVDiAawxvqLyW6pU/s320/mae56.xwd.png"/></a></div>

Despite TattleTech finding the virtual NuBus video card, <tt>sltc</tt> insists there aren't any NuBus slots.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjq2NARWy31iOhIpx8rqg3imb8ujVFJStErMST_towgc-bv0dLXvuulINUSSkUEvbwKZU8GuYgI69rs7VWOElVGEk97naor6xBUdbWjkoF_Hfttu30eZnNbq7FB-EilezHjNkSO6g9skOhNYe-nmPor3XFWKhA2CIPFqEP-98QZBYSr6gwUZk2HUNS0b-w/s1024/mae57.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjq2NARWy31iOhIpx8rqg3imb8ujVFJStErMST_towgc-bv0dLXvuulINUSSkUEvbwKZU8GuYgI69rs7VWOElVGEk97naor6xBUdbWjkoF_Hfttu30eZnNbq7FB-EilezHjNkSO6g9skOhNYe-nmPor3XFWKhA2CIPFqEP-98QZBYSr6gwUZk2HUNS0b-w/s320/mae57.xwd.png"/></a></div>

Finally, one more unique selector value is under <tt>snhw</tt> for the sound hardware, which reports a driver <tt>cith</tt>. This likewise appears nowhere else and is specific to the MAE emulated audio hardware. Oddly, although MAE 1.0 lacked sound, Ren&eacute;'s list indicates an <tt>snhw</tt> of <tt>awac</tt> which would suggest <a href="/2022/12/the-strange-case-of-beos-srs-and-silent.html">an AWACS</a>.
<p>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEitFzhaFkaDOYCshBMfU9LoS1wqFwZOBQM99SlOHXTm1IyL9_KoHVLsOTY6y2Dr1auQZzH2DdkEHJRyP7pOPKZ-bnRN9Ou4AkkeD4jlPePd6ai90fde22IxU_fFRKU679QOAYg2o3U-k-7QJc_qUsi_Dn6PBAT0kE2JqgCrV9CXZcKNAXlUhIJvrt5hR3E/s1024/mae59.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEitFzhaFkaDOYCshBMfU9LoS1wqFwZOBQM99SlOHXTm1IyL9_KoHVLsOTY6y2Dr1auQZzH2DdkEHJRyP7pOPKZ-bnRN9Ou4AkkeD4jlPePd6ai90fde22IxU_fFRKU679QOAYg2o3U-k-7QJc_qUsi_Dn6PBAT0kE2JqgCrV9CXZcKNAXlUhIJvrt5hR3E/s320/mae59.xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhj6Slj4DNlRT8N5rrWvLOINmX66tO476t3v30ls0jVirfznQJS5bJ6cTBn7D1C0Ze2j_XhQoMUBQTg79p9mgzzALrNdrw7LKDnw2oWxLP7fU7BGYpZGxkeHL-oHAnrZmgVudZKauEKdII3joWBZ7WFhXDJzj_sG9sJVB3LNWaPxGpEEhyphenhyphen3TCO1a-GNkvs/s1024/mae60.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhj6Slj4DNlRT8N5rrWvLOINmX66tO476t3v30ls0jVirfznQJS5bJ6cTBn7D1C0Ze2j_XhQoMUBQTg79p9mgzzALrNdrw7LKDnw2oWxLP7fU7BGYpZGxkeHL-oHAnrZmgVudZKauEKdII3joWBZ7WFhXDJzj_sG9sJVB3LNWaPxGpEEhyphenhyphen3TCO1a-GNkvs/s320/mae60.xwd.png"/></a></div>

And, after restart, we now have 45MB of RAM.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEicc0f82uS7v-mWtiIUlpAkMBjmdYqYRcxB6ulxDZNeiZQH883DzN-gK9F66ojKH60gw_93QX1wZuUWd9_nY83WVBfkf1NVZo8iXdVXPwThKzx_hfojH06BNcin72VM69spI8RgX7iBfz-KjkU-_Ew6wEdrqpstRMXcSsvFlT2xengEtMjlCDKueqGMg7w/s1024/mae61.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEicc0f82uS7v-mWtiIUlpAkMBjmdYqYRcxB6ulxDZNeiZQH883DzN-gK9F66ojKH60gw_93QX1wZuUWd9_nY83WVBfkf1NVZo8iXdVXPwThKzx_hfojH06BNcin72VM69spI8RgX7iBfz-KjkU-_Ew6wEdrqpstRMXcSsvFlT2xengEtMjlCDKueqGMg7w/s320/mae61.xwd.png"/></a></div>

Fetch, the venerable Macintosh FTP client &mdash; <a href="https://fetchsoftworks.com/">still sold!</a> &mdash; was a bit of a mixed bag on MAE. 2.1.2 was the 68K version I had on <tt>thule</tt>, so I tried that first. It starts and runs fine, but when I actually tried to download anything with this version of Fetch it locked up the entire emulated Mac as soon the file was transferred. That said, I'm not sure if this is a fault of MAE or Fetch because at the exact same point of the exact same file with the exact same version of Fetch on the 540c, it abruptly dropped the connection and threw an error message &mdash; though I note transfer speeds were faster on MAE, probably because of the better hardware, right up until it hit the wall.
<p>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEju3KW8vKIq6erOEJ2PQSRQIx13fuJFJR-iKM-wD5sZN5Lyzdi-Tn7qsPJZhUY4GJwCLcwJzObAe40yNjuqI8Mlkp0B1qL90XCUL2YX2-Y6HJFwMpOS_fDcEt2dWtuKXuR2Gf77kP7TL5FAiQ3azCoZN_OGUOsll8sT5USmp3ecuWO8-b__XplUBdZDQRk/s1024/mae62.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEju3KW8vKIq6erOEJ2PQSRQIx13fuJFJR-iKM-wD5sZN5Lyzdi-Tn7qsPJZhUY4GJwCLcwJzObAe40yNjuqI8Mlkp0B1qL90XCUL2YX2-Y6HJFwMpOS_fDcEt2dWtuKXuR2Gf77kP7TL5FAiQ3azCoZN_OGUOsll8sT5USmp3ecuWO8-b__XplUBdZDQRk/s320/mae62.xwd.png"/></a></div>

Unfortunately, <a href="https://github.com/cy384/ssheven"><tt>ssheven</tt></a>, which works great on my real Macs, crashes on MAE and I'm not sure why.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgeKmy5JC0zBX2ohmla-Pc6iYTtHQ3qihaXxG_pEdH0HJX3DjBsRW7n57Gvpmx1-n1LJ09kOh0ms9PNwQn2ytezFiFlW-NgKKcnfUdSXCHBQg1RgJuEQs8V2tyEKU9Y5ntF66BXRCPmoVpDs1lOIW-R2lZ93ZAhO33nbp6TE-7suThmHiXk9uJc8PP0Yc0/s1024/mae63.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgeKmy5JC0zBX2ohmla-Pc6iYTtHQ3qihaXxG_pEdH0HJX3DjBsRW7n57Gvpmx1-n1LJ09kOh0ms9PNwQn2ytezFiFlW-NgKKcnfUdSXCHBQg1RgJuEQs8V2tyEKU9Y5ntF66BXRCPmoVpDs1lOIW-R2lZ93ZAhO33nbp6TE-7suThmHiXk9uJc8PP0Yc0/s320/mae63.xwd.png"/></a></div>

In fact, at one point the crash was so severe it actually caused MAE itself to quit, whereupon I was chastised for an improper shutdown when bringing it back up. This special variant of the usual Mac "didn't Shut Down" window is unique to MAE. I'm not sure if the crash is exploitable but it's not good news regardless. This is probably a problem in MAE specifically rather than <tt>ssheven</tt>, though I'd have to get a better debugger up on it to figure it out.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjQopn-OpOxe9B9PE8aDdjdtMfC2Nf0oB2jvRxZvJfLJfw61r7u9OyhqJXkqdNqG2oLCeIGiZCqS-goQ6hXruXsEvYtU8BNdkIeTGMcnyJDROAzlmbjkCxT6VlzB3vpZld2NY7TiWqzqgJZ2Z1k3eQgZALGi8P_dQVjsSROVVCsJLFUwAuuAZHK-l3HMOU/s1024/mae64.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjQopn-OpOxe9B9PE8aDdjdtMfC2Nf0oB2jvRxZvJfLJfw61r7u9OyhqJXkqdNqG2oLCeIGiZCqS-goQ6hXruXsEvYtU8BNdkIeTGMcnyJDROAzlmbjkCxT6VlzB3vpZld2NY7TiWqzqgJZ2Z1k3eQgZALGi8P_dQVjsSROVVCsJLFUwAuuAZHK-l3HMOU/s320/mae64.xwd.png"/></a></div>

The old MacSSH didn't do much better. Telnet was fine and worked fine, and I had already expected that SSH2 sessions would take a while to negotiate keys (back in the day when I used my Quadra 605 for this with a 25MHz full 68040, it took about 45 seconds). However, this connection to a local test host locked up hard. The MAE manual says that Command-Option-Esc doesn't work for quitting a hung Mac application, but it actually does &mdash; you just have to blindly click the Force Quit button (leftmost). As with any real Mac, though, you really should restart afterwards.
<p>
These aren't fatal flaws, however, because we could also just use a CDE terminal window for Telnet and <tt>ssh</tt>, and that would even be more useful. Instead, we should  try something <em>really</em> important next.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiKP2K36ex0tmbbiH01mEU2D-rVGUkfXhjCG-4JH3aHIS8tO0gbdk-_X8uc1uNykWnwATutP4koi9esGtwwGyeDqFYDpV2r7fUObIMkn1AS7TJbw3kJ7UU9DJtp8MHFCGH3eCKPnGmfVqoAkueilVvLojn5wjtC_I4jJlMDZy7P16EZck4DIXShU5SzaBQ/s4080/PXL_20250726_152214854~2.jpg" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" height="320" data-original-height="4080" data-original-width="3072" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiKP2K36ex0tmbbiH01mEU2D-rVGUkfXhjCG-4JH3aHIS8tO0gbdk-_X8uc1uNykWnwATutP4koi9esGtwwGyeDqFYDpV2r7fUObIMkn1AS7TJbw3kJ7UU9DJtp8MHFCGH3eCKPnGmfVqoAkueilVvLojn5wjtC_I4jJlMDZy7P16EZck4DIXShU5SzaBQ/s320/PXL_20250726_152214854~2.jpg"/></a></div>

The Macintosh port of Wolfenstein 3D was done by Rebecca Heinemann and her team when she was still at Interplay, under their MacPlay label. It came in both this full version on multiple floppies, which is the one I bought at retail back in the day, and a shareware three-level "First Encounter" which was criticized as poor value for free. The Mac version is related to the enhanced Atari Jaguar port and uses higher resolution textures, sprites and sound than the original DOS version, plus a different status bar, new weapons and thirty more "Second Encounter" levels from the Super NES and Jag; the 3DO and <a href="/2021/02/the-quest-for-wolfenstein-3d-music-on.html">Apple IIgs</a> versions are derived from the Mac version. This port was released in 1994 and the "Accelerated for Power Macintosh" and "System 7 Savvy" stickers give the rough timeframe. It requires a 25MHz 68030 or better and is a fat binary.
<p>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsE
xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgM9E5YwyuRTztkQWlzZyrSkXVAFxZB4Zha94ScAE_o_f6Gi1l3cwE3PClr1ZOkn3NtkV0CdiJ8BmErNoSsN22y25v6d6WE7lNJg_YOGR31JNTFWdxXkWFnTeCAwa9gi5kGDNnfwBAuVHivmWUZ5iUxqh3QDG319av8k9xOXbGXgTG_UEdEpivYrIx1WBg/s1024/mae72.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgM9E5YwyuRTztkQWlzZyrSkXVAFxZB4Zha94ScAE_o_f6Gi1l3cwE3PClr1ZOkn3NtkV0CdiJ8BmErNoSsN22y25v6d6WE7lNJg_YOGR31JNTFWdxXkWFnTeCAwa9gi5kGDNnfwBAuVHivmWUZ5iUxqh3QDG319av8k9xOXbGXgTG_UEdEpivYrIx1WBg/s320/mae72.xwd.png"/></a></div>

One particular reason I wanted to test Wolf3D is because it can operate in both QuickDraw and direct-to-video memory modes. When Use QuickDraw is checked (the default), Wolf3D restricts itself to documented QuickDraw calls, which is the slowest but most compatible option and works with pretty much any video card or machine. When Use QuickDraw is <em>un</em>checked, the game will try to draw directly to video memory. This doesn't always work, and as you can see in this screenshot, not all of the screen was updating properly in this mode.
<p>
This observation will become relevant when we try running our next game. You do see where this is going, don't you?
  
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhWfZWds-Jrtt0hG404AqAhzJZhnaKbvjUO6kF24FDWlPID9yxbfMlkeJu3ZEaWBHwH0HZeYiJA1Fa9AKF5n7kQ1M29vuj8YZrHaZkD0arFdF1dMSwhG-htyl-7T1vfgOi8Lz_1dMFTPai8ZmW3C6r53uv6durlu2LTyOYT9llXqjAZ-Z8raSVjAsYlk-8/s4080/PXL_20250726_201841361~2.jpg" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" height="320" data-original-height="4080" data-original-width="3072" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhWfZWds-Jrtt0hG404AqAhzJZhnaKbvjUO6kF24FDWlPID9yxbfMlkeJu3ZEaWBHwH0HZeYiJA1Fa9AKF5n7kQ1M29vuj8YZrHaZkD0arFdF1dMSwhG-htyl-7T1vfgOi8Lz_1dMFTPai8ZmW3C6r53uv6durlu2LTyOYT9llXqjAZ-Z8raSVjAsYlk-8/s320/PXL_20250726_201841361~2.jpg"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiGwCSDgjRlQ3EefI9jnVq-zfP55Xh_Rb2teDAbG3l5sqHtr5SuJThEbqigtctIs-fqYdZ8F3m898bbETTs_xprJYlhtDMVk3o5jpkOoq8-coMLPrsfjat4NdXbP1Y1CMELfU93lPErMDi54w7B1IvkxPn0ZotGJ0uhUnnslTGvq_jWlczVP-10S1W-qsU/s1024/mae75.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiGwCSDgjRlQ3EefI9jnVq-zfP55Xh_Rb2teDAbG3l5sqHtr5SuJThEbqigtctIs-fqYdZ8F3m898bbETTs_xprJYlhtDMVk3o5jpkOoq8-coMLPrsfjat4NdXbP1Y1CMELfU93lPErMDi54w7B1IvkxPn0ZotGJ0uhUnnslTGvq_jWlczVP-10S1W-qsU/s320/mae75.xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj-O5VXdKHDHyhyMz6FtvmiLeWLywmAVZ_pzPimdlknqQaF1Gv7HhE9R2AMhkbAFOdRGH6mSkpucsmyldbrSd_3w2KxJ4qZjKhENp0neIvSQaJkj5SmvD9lr2EWixOV7Aj26JjbT1OfxGC_XXZeESYgL_iXN_B4TE2sMN0WI0QgjH_EDMJpVkkjrEzzpek/s1024/mae73.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj


<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhVnoANygQSCQuzAQFRffBWS-Y62Jfbp4dp_tJ8KGnj0KZuGVgsHT2-sWcquZ2_YzQNIVJCPfiRE-__1xb-G25VHxlD7QtfndYhnTvb1jOsDPZI30AHQbOeR_jmKA3bXF00uhAK7QjpWCxkkWtGsWek9Gwod_2vYUQj3QD7zuG3tJjoSMQd5gFJnqRgy6g/s1024/mae80.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhVnoANygQSCQuzAQFRffBWS-Y62Jfbp4dp_tJ8KGnj0KZuGVgsHT2-sWcquZ2_YzQNIVJCPfiRE-__1xb-G25VHxlD7QtfndYhnTvb1jOsDPZI30AHQbOeR_jmKA3bXF00uhAK7QjpWCxkkWtGsWek9Gwod_2vYUQj3QD7zuG3tJjoSMQd5gFJnqRgy6g/s320/mae80.xwd.png"/></a></div>

Since even the QuickDraw-drawn loading screen is getting cropped, I suspect that Doom won't handle this screen resolution ...

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjgvY0Hrw8c5YL5wj5NyArzLhyqE4djKfySY0cr2vncVNc5yA1ZxG-sT02lNVkPcroOoGFmzuX_WRiV_GuJS-BOrCVVCQUvlca2rhZmDLU0Vm4fOc60cZpEi_6p9y5apMZmts0wODOfzyC1MXOYmI4HdtN9MbvuzyK-C3JAOlyCdOGMCSPiGO0dL5VRjgM/s1024/mae81.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjgvY0Hrw8c5YL5wj5NyArzLhyqE4djKfySY0cr2vncVNc5yA1ZxG-sT02lNVkPcroOoGFmzuX_WRiV_GuJS-BOrCVVCQUvlca2rhZmDLU0Vm4fOc60cZpEi_6p9y5apMZmts0wODOfzyC1MXOYmI4HdtN9MbvuzyK-C3JAOlyCdOGMCSPiGO0dL5VRjgM/s320/mae81.xwd.png"/></a></div>
...
<p>
In a vague attempt at productivity I loaded the classic Microsoft Word 5.1 onto MAE, though I was pretty sure Apple would have tested an app that common to ensure it would work. This is also on the Netatalk share on <tt>thule</tt>, but copying Word 5.1 over was a much bigger situation than simply grabbing a single file and its resource fork; we had a number of double-forked files we needed to move <i>en masse</i>. This Perl script, which works on both Perl 5 and 4.036, will iterate over a copy and move Netatalk's AppleDouble resource files into the proper location for MAE, resolving ambiguities in filenames if needed.
<p>
<div class="tx"><pre>
#!/usr/bin/perl
...
<p>
Call it with <tt>find [directory] -name '.AppleDouble' -print | perl ad2mae</tt> to run. Only run this on a copy! When everything was in the right place, I moved the directory into my <tt>Mac</tt> folder and it was ready to go.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiAuaMgJUAM5ioTR4XHC6RXg2h5m1NlVct8iApWumcbsdpkOfY5m_Ehw0FyVwuYhwpXzPReM0frfSDxqF69gv8kxxrzcFrRNZYQBZJm36bS5vnzIz9fsqDSqw2OfKGEJn-FegQxWXt5wZfY_NfkyqnpTKFXcE9k0qNaB-fq-AJRaeYud86heIituStThsI/s1024/mae85.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiAuaMgJUAM5ioTR4XHC6RXg2h5m1NlVct8iApWumcbsdpkOfY5m_Ehw0FyVwuYhwpXzPReM0frfSDxqF69gv8kxxrzcFrRNZYQBZJm36bS5vnzIz9fsqDSqw2OfKGEJn-FegQxWXt5wZfY_NfkyqnpTKFXcE9k0qNaB-fq-AJRaeYud86heIituStThsI/s320/mae85.xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjIOygR39vZKtBGHV2BAzKSAZdFgB706MJ_jTg-nXDRCWb5W34gQu9rzUfZU4Kv4Nef0FvPgehnu2W3XtN7C4gENfGdZxX9VqfiCzKTlcu-KZAC26W-eRHm7_CpRrNVkwLHjbKbj_RIqTqjWnupjSOSXtnGrdbCJqKrEgvln7OG6jPrM_47IIBTTIO1-3c/s1024/mae93.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjIOygR39vZKtBGHV2BAzKSAZdFgB706MJ_jTg-nXDRCWb5W34gQu9rzUfZU4Kv4Nef0FvPgehnu2W3XtN7C4gENfGdZxX9VqfiCzKTlcu-KZAC26W-eRHm7_CpRrNVkwLHjbKbj_RIqTqjWnupjSOSXtnGrdbCJqKrEgvln7OG6jPrM_47IIBTTIO1-3c/s320/mae93.xwd.png"/></a></div>

Incidentally (especially since I didn't have the execute bits on it), when I double-clicked the Perl script <tt>ad2mae</tt> from the MAE Finder, the Finder determined it was a text file and opened it up in <tt>vi</tt> in a CDE window ready for editing. Not bad!
<p>
As MAE 3.0 specifically advertised that it was faster than previous versions over remote X, let's test how well that works from my POWER9 Raptor Talos II in Fedora 42. Being the Wayland refusenik I am, I still run KDE Plasma in X11, so with <tt>xhost</tt> set appropriately and <a href="https://www.talospace.com/2023/01/your-x-server-may-no-longer-swing-both.html"><tt>AllowByteSwappedClients</tt></a> enabled (because the POWER9 is running Power ISA little-endian and the PABook is running big) we should be able to connect:

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiBOP6WpARKjyK7ju4cuY0TG-hOpIX7Yns3dtV3hTBHoDDRn8bmxL_EGyaw_qoEJllrV8g0KEliyqZhxSjzLThYSnZtF8RNuoxQGaBVRzSE5_dWjwNUSLZTp78aamAzGyifQJ2nEM4uvu7JwVIcL6szAz2C4th_PQQZdyzX2ebd1x711L7pzHqTH66xZUI/s1480/rmae1.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="730" data-original-width="1480" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiBOP6WpARKjyK7ju4cuY0TG-hOpIX7Yns3dtV3hTBHoDDRn8bmxL_EGyaw_qoEJllrV8g0KEliyqZhxSjzLThYSnZtF8RNuoxQGaBVRzSE5_dWjwNUSLZTp78aamAzGyifQJ2nEM4uvu7JwVIcL6szAz2C4th_PQQZdyzX2ebd1x711L7pzHqTH66xZUI/s320/rmae1.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiDrv7n_-bPpwH88Oqaenee0B73P4yhF-3Bcg2RU5BYkm7KcPinA5Yvi2VkPxENy5en9yb_FimtMJYSA6Bm4pbyWLNqqFuk_B_xU-8DeHN9VcR5v__Hn7GH0hkPcKlWIjTQsIlZXMktoBjU3XHighUiKif7r0gAgOFSKHFjvU4qggjTDXWJh_EMpdj6JK4/s984/rmae2.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="804" data-original-width="984" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiDrv7n_-bPpwH88Oqaenee0B73P4yhF-3Bcg2RU5BYkm7KcPinA5Yvi2VkPxENy5en9yb_FimtMJYSA6Bm4pbyWLNqqFuk_B_xU-8DeHN9VcR5v__Hn7GH0hkPcKlWIjTQsIlZXMktoBjU3XHighUiKif7r0gAgOFSKHFjvU4qggjTDXWJh_EMpdj6JK4/s320/rmae2.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgNq9mmDabooTTJRAH5NjbYnVHAxfrHK6gnzJwyavM8saQp_21vnjmPJiFUlu1nLjeGpD70OyTTGWfi1543zHtY2DYVBGtM8JbDw7XBPpCill5FEAnDChJNjZsIk0jkYZHjU464q3rnVpKJvpwj9AEvx9OTb0Uvm_QLi6XNMK3ToIXLKu9v6pekxyO3VJg/s984/rmae3.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="804" data-original-width="984" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgNq9mmDabooTTJRAH5NjbYnVHAxfrHK6gnzJwyavM8saQp_21vnjmPJiFUlu1nLjeGpD70OyTTGWfi1543zHtY2DYVBGtM8JbDw7XBPpCill5FEAnDChJNjZsIk0jkYZHjU464q3rnVpKJvpwj9AEvx9OTb0Uvm_QLi6XNMK3ToIXLKu9v6pekxyO3VJg/s320/rmae3.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEihcR_jYtqv0XzN3jvWVEq8R7AUbRbjsPXQuDb7luWTlj4gE-BLwy9IW84spOgy9aXpT71OLYOiZfuD1Q4nBSx5HTT_Y0Kd2AbrZGKu5qXSFhXy9-13LZGlv-ECNlc2SuUWqPeEI9J8P5MNTfnLn13ptcgIsHhXLBnzfDqzh3ZDNceggW-KmWilkfOPTQg/s984/rmae4.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="804" data-original-width="984" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEihcR_jYtqv0XzN3jvWVEq8R7AUbRbjsPXQuDb7luWTlj4gE-BLwy9IW84spOgy9aXpT71OLYOiZfuD1Q4nBSx5HTT_Y0Kd2AbrZGKu5qXSFhXy9-13LZGlv-ECNlc2SuUWqPeEI9J8P5MNTfnLn13ptcgIsHhXLBnzfDqzh3ZDNceggW-KmWilkfOPTQg/s320/rmae4.png"/></a></div>

For apps with a modest amount of screen updates, this works very well. Pull-down menus had a little bit of lag but typing into a Word document was fine. I did have to go into the Keyboard control panel and remap my <em>actual</em> Command and Option keys, though (I use a white A1048 USB Apple Keyboard with the Quad G5 and the Talos II).

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhuoD-BP6z2P6N0pFBBNnJuqmfyUg_iGWNTPLt-tQ2OPaPgYkZweuHzN4zkcMZe36YhCd1woQOIAEEl3yQn06ACbM_vzYcVs9weLybnh_HB0yhvY8725WxKWLJP8nEV0GJDAzpSTOcGsCw6jMRgeDkSeYkWchOkWJpilYLK9gxcidoiToog1ytXqIvAtNg/s984/rmae5.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="804" data-original-width="984" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhuoD-BP6z2P6N0pFBBNnJuqmfyUg_iGWNTPLt-tQ2OPaPgYkZweuHzN4zkcMZe36YhCd1woQOIAEEl3yQn06ACbM_vzYcVs9weLybnh_HB0yhvY8725WxKWLJP8nEV0GJDAzpSTOcGsCw6jMRgeDkSeYkWchOkWJpilYLK9gxcidoiToog1ytXqIvAtNg/s320/rmae5.png"/></a></div>
...
<p>
We'll close now with one last application &mdash; ResEdit &mdash; because now that we've seen it ticking we'd like a few insights into what <em>makes</em> it tick.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh-TCRsJKbi2kmq4iWbBWzhHZOZzAu0OGpUitz5MnMExlcR_2R4_vYMIjZc-GNThkL1QPIxipRhYnkcZ2BeTmYFOLFuHRqHV_r66eYwIKvh92ghBO24L5IzNRSucgBjKqy3FZw14ih5hNmLKBoPH7Qcb6vo9SBHhYew9519DZooSqrawGv7jfPcRpbVQCc/s1024/mae86.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh-TCRsJKbi2kmq4iWbBWzhHZOZzAu0OGpUitz5MnMExlcR_2R4_vYMIjZc-GNThkL1QPIxipRhYnkcZ2BeTmYFOLFuHRqHV_r66eYwIKvh92ghBO24L5IzNRSucgBjKqy3FZw14ih5hNmLKBoPH7Qcb6vo9SBHhYew9519DZooSqrawGv7jfPcRpbVQCc/s320/mae86.xwd.png"/></a></div>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgW_qTXWxeSd8E9WVNmFsVp9tfu_iMj4u9GG8gm8kvKoAgletrHOi8JOKgd7TMMD8CrlcZ-cdpSUjBsYiN2-L8L0WjDhD_nL86UwUNAht8tYaW_5MdZzT93SzeUBy442wrlyfn4bMBp1_yr0UxWjdB_5omK1bVdy51RUMyM30nbx90kPaknhEHFGxKXZFc/s1024/mae87.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgW_qTXWxeSd8E9WVNmFsVp9tfu_iMj4u9GG8gm8kvKoAgletrHOi8JOKgd7TMMD8CrlcZ-cdpSUjBsYiN2-L8L0WjDhD_nL86UwUNAht8tYaW_5MdZzT93SzeUBy442wrlyfn4bMBp1_yr0UxWjdB_5omK1bVdy51RUMyM30nbx90kPaknhEHFGxKXZFc/s320/mae87.xwd.png"/></a></div>

The Enabler contains the GUI-level pieces of the MAE Helper (which makes sense, since it contains the MAE Helper generally). Here's the <tt>DLOG</tt> modal when MAE is formatting the TIV.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEig5tB61d7NAtmhDkoCNYhnEnXBcHFxCbooE7zOh8R-bM9DN6hjdY36dV8xKc63Sei_Z7oYryQfpSXnMTtWTWvT6zwttFyBRk9r4kKCTPiCtNnQYzYzv0r7WpgK1PV3EYno-U4IbvJb1XFeLgJ_3qxKY0vctc8Rse8GIdezRweEArvpVewKDavLiidyHdc/s1024/mae88.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEig5tB61d7NAtmhDkoCNYhnEnXBcHFxCbooE7zOh8R-bM9DN6hjdY36dV8xKc63Sei_Z7oYryQfpSXnMTtWTWvT6zwttFyBRk9r4kKCTPiCtNnQYzYzv0r7WpgK1PV3EYno-U4IbvJb1XFeLgJ_3qxKY0vctc8Rse8GIdezRweEArvpVewKDavLiidyHdc/s320/mae88.xwd.png"/></a></div>

And here's one of the <tt>DLOG</tt>s for the MAE Toolbar help we saw earlier.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjTpqgftQgr51oz22vS4TjdqYSW_UDzZo1p-DrswkRIkFpuizN6weKeosgcW4qgLcrvBuDSm8mAMzCpxfFat3qF78n78KMrNAl2v0VdrBGLaZMYc3BISAG4aU2XXLcOTWweJtd_ne3s16qe6Jk7rBU14NT-g0bUvWeWOMmPvxFaskROADy1hdYCJwYHANI/s1024/mae89.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjTpqgftQgr51oz22vS4TjdqYSW_UDzZo1p-DrswkRIkFpuizN6weKeosgcW4qgLcrvBuDSm8mAMzCpxfFat3qF78n78KMrNAl2v0VdrBGLaZMYc3BISAG4aU2XXLcOTWweJtd_ne3s16qe6Jk7rBU14NT-g0bUvWeWOMmPvxFaskROADy1hdYCJwYHANI/s320/mae89.xwd.png"/></a></div>

This <tt>DLOG</tt> is one of the modals for the floppy/CD mounter.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiMRCMgsPryMQCPXlJSpBFJZuVSEe64qjV0D0_TMUl0o-R_f3z4MwdbOMBKnZ1m76Xk-zXKGeK8JHyR0AFKUSFy0KNfEX2l4MVBS3h59wS53urtCcnrOl0kAbdLfcuTFBMEsjqR0tGSlhHLG1CzJhksFMGTOLjPZ9-36w2dQXgxJTIKoNxLLRNn0Jn6sJI/s1024/mae90.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiMRCMgsPryMQCPXlJSpBFJZuVSEe64qjV0D0_TMUl0o-R_f3z4MwdbOMBKnZ1m76Xk-zXKGeK8JHyR0AFKUSFy0KNfEX2l4MVBS3h59wS53urtCcnrOl0kAbdLfcuTFBMEsjqR0tGSlhHLG1CzJhksFMGTOLjPZ9-36w2dQXgxJTIKoNxLLRNn0Jn6sJI/s320/mae90.xwd.png"/></a></div>

This <tt>DITL</tt> looks like it's part of a credits easter egg, though I haven't figured out yet how to trigger it. I'm assuming the dog is named Rosco ("In Memory of Rosco - 10/5/96"). Also note the dog's Dr Seuss hat, a callback to MAE's "Cat-in-the-Hat" codename.
<p>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiv6Qqcilm-dGBgsUHXHUb-5gy0MnDHYbrNmgL3dV4E8YoGF9MznFSLX-CXcjvJ2oXEfPszA5Oujv8V19tdxGxBa6xgQRp6463XTKfj-s2q8-tJQkT6KqrEuCxpg0KNgzBI08N9pOFzgcIX8SheLjwC_ZF34YwKhs_SodBSNhB5-22MOcyMCpN_AI6PB_8/s1024/mae91.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiv6Qqcilm-dGBgsUHXHUb-5gy0MnDHYbrNmgL3dV4E8YoGF9MznFSLX-CXcjvJ2oXEfPszA5Oujv8V19tdxGxBa6xgQRp6463XTKfj-s2q8-tJQkT6KqrEuCxpg0KNgzBI08N9pOFzgcIX8SheLjwC_ZF34YwKhs_SodBSNhB5-22MOcyMCpN_AI6PB_8/s320/mae91.xwd.png"/></a></div>

These members of the MAE team, however, don't seem to be listed anywhere else.
<p>
Marketing and Support: J. Eric Akin, Ruthanne Baker-Mander, Dennis Chen, Richardo Gonzalez, Suzanne Seibert<br>
Product Testing: Paul Burriesci, Dan Carpenter, Chris Chapman, Kevin Walters<br>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhkexHZoG0-nPb1mJQ77kP9Iliq4C1H2i7gD05SJCfDZViEBbR2lzWdmc2GQQS-q0NzEX9lUq5uhOc0e_G6UDhKIpvbRDXVANJmrqyVQ4EKr4adYPoa__LCu27cjC9oPWhe8xMTnngeXmZS9qsk11MybT0NPrNvTuuxniVXs8bZZ6p5giCJNrPekqbm5go/s1024/mae92.xwd.png" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="768" data-original-width="1024" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhkexHZoG0-nPb1mJQ77kP9Iliq4C1H2i7gD05SJCfDZViEBbR2lzWdmc2GQQS-q0NzEX9lUq5uhOc0e_G6UDhKIpvbRDXVANJmrqyVQ4EKr4adYPoa__LCu27cjC9oPWhe8xMTnngeXmZS9qsk11MybT0NPrNvTuuxniVXs8bZZ6p5giCJNrPekqbm5go/s320/mae92.xwd.png"/></a></div>

I also noticed these icons in amongst the other expected <tt>PICT</tt>s. I'm not sure what they refer to. Notice that the <tt>Toolbar Menu</tt> when you use the third mouse button is actually just a bunch of PICT resources.
<p>
There are some other interesting things of note when we start going through the binaries. I separately extracted the files from the installer packages (they're just <tt>cpio</tt> archives) to preserve their time stamps for analysis. Let's look at everything that's there and then dig into the most notable individual files.
<p>
<div class="tx"><pre>
% ls -l bin
total 12648
...
<p>
Of the library files, <tt>data</tt> and <tt>engine</tt> are probably the most notable. We will look at those seprately.
<p>
<tt>KeymapDepotDB</tt> is where the default keymaps MAE uses are kept, and <tt>MajorUpdate</tt> is instructions to the installer script for how to perform an upgrade to a new major release. Since there's no MAE 4.0, this presumably will never be used again. The manual does not document what <tt>btree</tt> does, and it has only a single readable string in it: <tt>Copyright 1991 Apple Computer, Inc. All Rights Reserved. Ricardo Batista</tt>
<p>
...
<p>
After installation <tt>Default_MIV_file</tt> also lives in <tt>/opt/apple/lib</tt>, and optionally <tt>AliasList</tt> for default aliases to appear when starting MAE.
<p>
To reduce the size of individual users' System Folders, a substantial portion of the composite MAE System Folder is pulled from the <tt>shared</tt> directory, and other pieces from <tt>/opt/apple/lib/data</tt>. 
<p>
<div class="tx"><pre>
% ls -alR shared
total 5424
...
<p>
<tt>/opt/apple/lib/data</tt> contains the rest of the System Folder, with common pieces like the System 7.5 jigsaw puzzle (licensed by Apple from Captain's Software), note pad (Light Software), scrapbook, menu bar clock (from Steve Christensen's SuperClock!), desktop patterns, compressed System resources and standard INITs and CDEVs. <tt>/opt/apple/sys</tt>, however, which we won't do much more with here, is the master template for creating each user's own System Folder. We don't need to look at it again because we already saw my own copy of it.
<p>
<tt>/opt/apple/lib/engine</tt> is a mashup of many miscellaneous tools. There are various conglomated binaries in it ratted out by the presence of <tt>.text</tt>, <tt>.data</tt> and <tt>.bss</tt>, plus the fake DeclROM for the virtual video card and the Quadra 660AV/840AV Toolbox ROM it uses. There are also many other interesting strings, and being a 10MB file, there are a lot of them:
<p>
<div class="tx"><pre>
...
<p>
Next we'll go through the main binaries, starting with <tt>legal</tt>, which is the program that requires you to accept the EULA on first run.
<p>
<div class="tx"><pre>
...
<p>
<tt>legal</tt> in particular looks like it's just an embedded Tcl/Tk script. It's also notable that <tt>appleping</tt>, <tt>appletalk</tt>, <tt>atlookup</tt>, <tt>asdtool</tt> and <tt>legal</tt> still have symbol tables. The AppleTalk tools in particular list functions related to DDP, LAP, NBP and RTMP, but you'd expect that (<tt>legal</tt> has symbols for Tcl/Tk instead). Interestingly, a few of the strings in <tt>appletalk</tt> suggest that LocalTalk might have been, or at least was considered for being, supported at one time.
<p>
Although <tt>mae</tt> is the binary that you run directly, <tt>macd</tt> is what handles a lot of the background stuff and <tt>mae</tt> communicates with it over IPC. The administrator's manual is (probably intentionally) vague about its exact functions, saying only that it "is a daemon that runs whenever <tt>apple/bin/mae</tt> runs and helps MAE interact with the UNIX environment. It also cleans up after <tt>mae</tt> if the <tt>mae</tt> process is killed." We can get a little better idea of what it does from its own set of strings at least:
<p>
<div class="tx"><pre>
% nm macd
nm:  macd:  no symbols
...
<p>
And now <tt>mae</tt> itself. Some of these strings and components are duplicative of what we saw in <tt>/opt/apple/lib/engine</tt>. I'm not sure why they're being used twice.
<p>
<div class="tx"><pre>
% nm mae
nm:  mae:  no symbols
...
<p>
It turns out that the <tt>mae</tt> binary has a second executable binary in it, called the Midnight Emulator. And we can run it!
<p>
<div class="tx"><pre>
...
<p>
The Midnight Emulator uses the same license file as regular MAE and wants an A/UX COFF file, an echo of its past. Fortunately we have an A/UX machine handy here too, our old friend <tt>spindler</tt>, my clock-chipped Quadra 800. We'll fire it up in A/UX 3.1.

<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjasu4dpOO5Y1q07df2D8oaqj1o1-t1dz6izfot79BG-bYnsOLIePlGVTEaJ8UM_tJlTlOgHiKIsus2xz8sxWNANvOFE4QiE8V-vnAbFi0wbx2Zzrw6J2QfpwOw9iX5wnkpkj5Qj6XQWB0pxc7PEF_emoRSmr2GGtF6L5joCQP81czUrrqI5dABjRyC2lA/s4080/PXL_20250727_035128071.jpg" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" height="320" data-original-height="4080" data-original-width="3072" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjasu4dpOO5Y1q07df2D8oaqj1o1-t1dz6izfot79BG-bYnsOLIePlGVTEaJ8UM_tJlTlOgHiKIsus2xz8sxWNANvOFE4QiE8V-vnAbFi0wbx2Zzrw6J2QfpwOw9iX5wnkpkj5Qj6XQWB0pxc7PEF_emoRSmr2GGtF6L5joCQP81czUrrqI5dABjRyC2lA/s320/PXL_20250727_035128071.jpg"/></a></div>
<p>
<div class="tx"><pre>
...
<p>
  <tt>/bin/sync</tt> looks like a very small, yet valid A/UX binary we can pull over and see if Midnight will run it. First, a quick negative control by running it on itself:
<p>
<div class="tx"><pre>
...
<p>
The complaint that it's <tt>neither COFF nor engine</tt> suggests that its normal state is to be running <tt>/opt/apple/lib/engine</tt>, though this isn't too interesting, since we would assume MAE does that ordinarily. Regardless, it doesn't like our real A/UX COFF binary, even though it does try to load it.
<p>
<div class="tx"><pre>
...
<div class="separator" style="clear: both;"><a href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiI6ZbF_c1ZLB4JHWSJvBSCJ0S0vM15Pg0gg5FypfIKnfR9Er47_3ACcYACWJosWGytnbI5DCg0iABTL_nNlvLqLT_ZN_qUN96z0UJXQwNbyxf4QUnl7Zd4O77ETTr4wiLOQouURsINAMTRZQ0Ja8c4GJkxamAYyJuSn-79jdhQEidu5gpc-IK3ueaxZhA/s4080/PXL_20250727_042840222.jpg" style="display: block; padding: 1em 0; text-align: center; "><img alt="" border="0" width="320" data-original-height="3072" data-original-width="4080" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiI6ZbF_c1ZLB4JHWSJvBSCJ0S0vM15Pg0gg5FypfIKnfR9Er47_3ACcYACWJosWGytnbI5DCg0iABTL_nNlvLqLT_ZN_qUN96z0UJXQwNbyxf4QUnl7Zd4O77ETTr4wiLOQouURsINAMTRZQ0Ja8c4GJkxamAYyJuSn-79jdhQEidu5gpc-IK3ueaxZhA/s320/PXL_20250727_042840222.jpg"/></a></div> 
